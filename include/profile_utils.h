...
#define MMLTK_PROFILE_SCOPE(name) ::mmltk::ScopedProfile MMLTK_DETAIL_CONCAT(mmltk_profile_scope_, __LINE__)(name)
#define MMLTK_PROFILE_ADD(name, value) ::mmltk::profile_add_value(name, static_cast<std::uint64_t>(value))
#define MMLTK_PROFILE_SET(name, value) ::mmltk::profile_set_value(name, static_cast<std::uint64_t>(value))
...
#define MMLTK_PROFILE_PROCESS_LABEL(label) ::mmltk::profile_set_process_label(label)
#define MMLTK_PROFILE_RUN_LABEL(label) ::mmltk::profile_set_run_label(label)
#define MMLTK_PROFILE_RESET_ITERATION() ::mmltk::profile_reset_iteration()
#define MMLTK_PROFILE_CAPTURE_ITERATION(label) ::mmltk::profile_capture_iteration(label)
#define MMLTK_PROFILE_FLUSH() ::mmltk::profile_flush()
...
inline void profile_enable() noexcept {}
