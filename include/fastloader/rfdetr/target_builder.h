...
struct BatchStaticTensors {
    ...
    torch::Tensor sizes_view(int64_t batch_size) const;
    torch::Tensor nested_mask_view(int64_t batch_size) const;
};
...
public:
    LoaderBatchGuard(fastloader::DatasetLoader& loader,
...
private:
    fastloader::DatasetLoader* loader_ = nullptr;
    fastloader::Batch batch_{};
    int device_id_ = 0;
