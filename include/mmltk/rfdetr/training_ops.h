...
public:
    ...
    [[nodiscard]] float current_scale() const { return scale_; }
    [[nodiscard]] int growth_tracker() const { return growth_tracker_; }
...
public:
    ...
    [[nodiscard]] const std::vector<torch::Tensor>& shadow_params() const { return shadow_; }
