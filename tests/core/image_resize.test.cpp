...
MMLTK_REGISTER_TEST_CASE("[core][image_resize]", test_resizer_rejects_internal_threading);
MMLTK_REGISTER_TEST_CASE("[core][image_resize]", test_same_size_copy_preserves_pixels);
MMLTK_REGISTER_TEST_CASE("[core][image_resize]", test_parallel_worker_local_resizers_are_stable);
