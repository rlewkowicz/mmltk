...
The [architecture and source guide](docs/architecture.md) maps the main
boundaries to their implementation. [CONTRACT.md](CONTRACT.md) is the
architectural authority; [AGENTS.md](AGENTS.md) defines development workflows.
Additional guides cover [GPU execution](docs/gpu-execution.md),
[headless Wayland validation](docs/headless-wayland.md), and
