...
[[nodiscard]] Container inflateWithWrapper(const Container& toDecompress, const std::optional<size_t> decompressedSize,
    ...
    gzip::BitReader bitReader(std::make_unique<BufferViewFileReader>(toDecompress.data(), toDecompress.size()));
