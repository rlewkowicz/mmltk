...
#if !defined(KRML_HEADER_TARGET_H)
...
#if !defined(KRML_HOST_EXIT)
#define KRML_HOST_EXIT exit
#endif

#if !defined(KRML_HOST_MALLOC)
#define KRML_HOST_MALLOC malloc
#endif

#if !defined(KRML_HOST_CALLOC)
#define KRML_HOST_CALLOC calloc
#endif

#if !defined(KRML_HOST_FREE)
#define KRML_HOST_FREE free
#endif

#if !defined(KRML_HOST_IGNORE)
...
#if !defined(KRML_ATTRIBUTE_TARGET)
#if defined(__GNUC__) || defined(__clang__)
...
#if !defined(KRML_ALIGNED_MALLOC)
