...
#else
#if 0 || defined(DGUX) || defined(HAVE_GETPAGESIZE)
...
#if !defined(ACQUIRE_MALLOC_GLOBAL_LOCK)
#define ACQUIRE_MALLOC_GLOBAL_LOCK()  ACQUIRE_LOCK(&malloc_global_mutex);
#endif

#if !defined(RELEASE_MALLOC_GLOBAL_LOCK)
