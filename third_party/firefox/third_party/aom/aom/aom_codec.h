 ...
 */
#if !defined(AOM_AOM_AOM_CODEC_H_)
...
#if !defined(AOM_DECLSPEC_DEPRECATED)
#if defined(__GNUC__)
...
#define AOM_CODEC_CONTROL_TYPECHECKED(ctx, id, data) \
  aom_codec_control_typechecked_##id(ctx, id, data) 
