...
#if !defined(AOM_AV1_COMMON_CFL_H_)
...
#define CFL_SUBSAMPLE_FUNCTION_ARRAY(arch, sub, bd)                           \
  static const cfl_subsample_##bd##_fn subfn_##sub[TX_SIZES_ALL] = {          \
    cfl_subsample_##bd##_##sub##_4x4_##arch,                         \
    cfl_subsample_##bd##_##sub##_8x8_##arch,                         \
    cfl_subsample_##bd##_##sub##_16x16_##arch,                     \
    cfl_subsample_##bd##_##sub##_32x32_##arch,                     \
    NULL,                                       \
    cfl_subsample_##bd##_##sub##_4x8_##arch,                         \
    cfl_subsample_##bd##_##sub##_8x4_##arch,                         \
    cfl_subsample_##bd##_##sub##_8x16_##arch,                       \
    cfl_subsample_##bd##_##sub##_16x8_##arch,                       \
    cfl_subsample_##bd##_##sub##_16x32_##arch,                     \
    cfl_subsample_##bd##_##sub##_32x16_##arch,                     \
    NULL,                                       \
    NULL,                                       \
    cfl_subsample_##bd##_##sub##_4x16_##arch,                      \
    cfl_subsample_##bd##_##sub##_16x4_##arch,                      \
    cfl_subsample_##bd##_##sub##_8x32_##arch,                      \
    cfl_subsample_##bd##_##sub##_32x8_##arch,                      \
    NULL,                                       \
    NULL,                                       \
  };
...
#define CFL_SUB_AVG_FN(arch)                                              \
  ...
  cfl_subtract_average_fn cfl_get_subtract_average_fn_##arch(             \
    ...
    static const cfl_subtract_average_fn sub_avg[TX_SIZES_ALL] = {        \
      cfl_subtract_average_4x4_##arch,                           \
      cfl_subtract_average_8x8_##arch,                           \
      cfl_subtract_average_16x16_##arch,                       \
      cfl_subtract_average_32x32_##arch,                       \
      NULL,                                 \
      cfl_subtract_average_4x8_##arch,                           \
      cfl_subtract_average_8x4_##arch,                           \
      cfl_subtract_average_8x16_##arch,                         \
      cfl_subtract_average_16x8_##arch,                         \
      cfl_subtract_average_16x32_##arch,                       \
      cfl_subtract_average_32x16_##arch,                       \
      NULL,                                 \
      NULL,                                 \
      cfl_subtract_average_4x16_##arch,      \
      cfl_subtract_average_16x4_##arch,      \
      cfl_subtract_average_8x32_##arch,      \
      cfl_subtract_average_32x8_##arch,      \
      NULL,                                 \
      NULL,                                 \
    };                                                                    \
     \
...
#define CFL_PREDICT_FN(arch, bd)                                            \
  ...
  cfl_predict_##bd##_fn cfl_get_predict_##bd##_fn_##arch(TX_SIZE tx_size) { \
    static const cfl_predict_##bd##_fn pred[TX_SIZES_ALL] = {               \
      cfl_predict_##bd##_4x4_##arch,                               \
      cfl_predict_##bd##_8x8_##arch,                               \
      cfl_predict_##bd##_16x16_##arch,                           \
      cfl_predict_##bd##_32x32_##arch,                           \
      NULL,                                   \
      cfl_predict_##bd##_4x8_##arch,                               \
      cfl_predict_##bd##_8x4_##arch,                               \
      cfl_predict_##bd##_8x16_##arch,                             \
      cfl_predict_##bd##_16x8_##arch,                             \
      cfl_predict_##bd##_16x32_##arch,                           \
      cfl_predict_##bd##_32x16_##arch,                           \
      NULL,                                   \
      NULL,                                   \
      cfl_predict_##bd##_4x16_##arch,                            \
      cfl_predict_##bd##_16x4_##arch,                            \
      cfl_predict_##bd##_8x32_##arch,                            \
      cfl_predict_##bd##_32x8_##arch,                            \
      NULL,                                   \
      NULL,                                   \
    };                                                                      \
       \
