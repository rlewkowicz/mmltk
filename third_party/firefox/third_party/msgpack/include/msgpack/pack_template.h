...
#if !defined(msgpack_pack_inline_func)
#error msgpack_pack_inline_func template is not defined
#endif

#if !defined(msgpack_pack_user)
#error msgpack_pack_user type is not defined
#endif

#if !defined(msgpack_pack_append_buffer)
...
#if defined(msgpack_pack_inline_func_fixint)
...
#if defined(msgpack_pack_inline_func_cint)
