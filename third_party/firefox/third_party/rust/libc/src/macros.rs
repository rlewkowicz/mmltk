...
#[cfg_attr(feature = "extra_traits", ::core::prelude::v1::derive(PartialEq, Eq, Hash))]
#[allow(deprecated)]
        $(#[$attr])*
        $pub struct $i { $($field)* }
    );
...
#[cfg_attr(feature = "extra_traits", ::core::prelude::v1::derive(Eq, Hash, PartialEq))]
#[::core::prelude::v1::derive(
            ::core::clone::Clone,
            ::core::marker::Copy,
            ::core::fmt::Debug,
...
macro_rules! c_enum {
    ...
    (@variant; ty: $_ty_name:ty; default: $_idx:expr; variants: []) => {  };
    (
        @variant;
        ty: $ty_name:ty;
