...
#[cfg_attr(feature = "rustc-dep-of-std", link(
                name = "c",
                kind = "static",
                modifiers = "-bundle",
                cfg(target_feature = "crt-static")
            ))]
#[cfg_attr(feature = "rustc-dep-of-std", link(name = "c", cfg(not(target_feature = "crt-static"))))]
extern "C" {}
...
#[cfg_attr(not(target_env = "uclibc"), link_name = "__isoc99_fscanf")]
pub fn fscanf(stream: *mut crate::FILE, format: *const c_char, ...) -> c_int;
#[cfg_attr(not(target_env = "uclibc"), link_name = "__isoc99_scanf")]
pub fn scanf(format: *const c_char, ...) -> c_int;
#[cfg_attr(not(target_env = "uclibc"), link_name = "__isoc99_sscanf")]
...
#[cfg_attr(all(not(gnu_time_bits64), gnu_file_offset_bits64), link_name = "fstat64")]
...
#[cfg_attr(all(not(gnu_time_bits64), gnu_file_offset_bits64), link_name = "stat64")]
...
#[cfg_attr(all(not(gnu_time_bits64), gnu_file_offset_bits64), link_name = "__fcntl_time64")]
...
#[cfg_attr(all(not(gnu_time_bits64), gnu_file_offset_bits64), link_name = "fstatat64")]
#[cfg(not(target_os = "l4re"))]
...
#[cfg_attr(all(not(gnu_time_bits64), gnu_file_offset_bits64), link_name = "lstat64")]
...
#[cfg_attr(any(target_os = "tvos", target_os = "watchos", target_os = "visionos"), link_name = "realpath$DARWIN_EXTSN")]
...
#[cfg_attr(any(not(any(target_env = "musl", target_env = "ohos")), target_os = "cygwin"), link_name = "__res_init")]
#[cfg_attr(any(target_os = "tvos", target_os = "watchos", target_os = "visionos"), link_name = "res_9_init")]
...
#[cfg_attr(all(target_env = "gnu", target_arch = "arm"), link_name = "cfgetispeed@GLIBC_2.4")]
#[cfg_attr(all(target_env = "gnu", target_arch = "csky"), link_name = "cfgetispeed@GLIBC_2.29")]
#[cfg_attr(all(target_env = "gnu", target_arch = "m68k"), link_name = "cfgetispeed@GLIBC_2.0")]
#[cfg_attr(all(target_env = "gnu", any(target_arch = "mips", target_arch = "mips32r6")), link_name = "cfgetispeed@GLIBC_2.0")]
#[cfg_attr(all(target_env = "gnu", target_arch = "powerpc"), link_name = "cfgetispeed@GLIBC_2.0")]
#[cfg_attr(all(target_env = "gnu", target_arch = "riscv32"), link_name = "cfgetispeed@GLIBC_2.33")]
#[cfg_attr(all(target_env = "gnu", target_arch = "sparc"), link_name = "cfgetispeed@GLIBC_2.0")]
#[cfg_attr(all(target_env = "gnu", target_arch = "x86"), link_name = "cfgetispeed@GLIBC_2.0")]
#[cfg_attr(all(target_env = "gnu", target_arch = "aarch64"), link_name = "cfgetispeed@GLIBC_2.17")]
#[cfg_attr(all(target_env = "gnu", target_arch = "loongarch64"), link_name = "cfgetispeed@GLIBC_2.36")]
#[cfg_attr(all(target_env = "gnu", any(target_arch = "mips64", target_arch = "mips64r6")), link_name = "cfgetispeed@GLIBC_2.0")]
#[cfg_attr(all(target_env = "gnu", target_arch = "powerpc64", target_endian = "big"), link_name = "cfgetispeed@GLIBC_2.3")]
#[cfg_attr(all(target_env = "gnu", target_arch = "powerpc64", target_endian = "little"), link_name = "cfgetispeed@GLIBC_2.17")]
#[cfg_attr(all(target_env = "gnu", target_arch = "riscv64"), link_name = "cfgetispeed@GLIBC_2.27")]
#[cfg_attr(all(target_env = "gnu", target_arch = "s390x"), link_name = "cfgetispeed@GLIBC_2.2")]
#[cfg_attr(all(target_env = "gnu", target_arch = "sparc64"), link_name = "cfgetispeed@GLIBC_2.2")]
#[cfg_attr(all(target_env = "gnu", target_arch = "x86_64", target_pointer_width = "64"), link_name = "cfgetispeed@GLIBC_2.2.5")]
#[cfg_attr(all(target_env = "gnu", target_arch = "x86_64", target_pointer_width = "32"), link_name = "cfgetispeed@GLIBC_2.16")]
pub fn cfgetispeed(termios: *const crate::termios) -> crate::speed_t;
#[cfg_attr(all(target_env = "gnu", target_arch = "arm"), link_name = "cfgetospeed@GLIBC_2.4")]
#[cfg_attr(all(target_env = "gnu", target_arch = "csky"), link_name = "cfgetospeed@GLIBC_2.29")]
#[cfg_attr(all(target_env = "gnu", target_arch = "m68k"), link_name = "cfgetospeed@GLIBC_2.0")]
#[cfg_attr(all(target_env = "gnu", any(target_arch = "mips", target_arch = "mips32r6")), link_name = "cfgetospeed@GLIBC_2.0")]
#[cfg_attr(all(target_env = "gnu", target_arch = "powerpc"), link_name = "cfgetospeed@GLIBC_2.0")]
#[cfg_attr(all(target_env = "gnu", target_arch = "riscv32"), link_name = "cfgetospeed@GLIBC_2.33")]
#[cfg_attr(all(target_env = "gnu", target_arch = "sparc"), link_name = "cfgetospeed@GLIBC_2.0")]
#[cfg_attr(all(target_env = "gnu", target_arch = "x86"), link_name = "cfgetospeed@GLIBC_2.0")]
#[cfg_attr(all(target_env = "gnu", target_arch = "aarch64"), link_name = "cfgetospeed@GLIBC_2.17")]
#[cfg_attr(all(target_env = "gnu", target_arch = "loongarch64"), link_name = "cfgetospeed@GLIBC_2.36")]
#[cfg_attr(all(target_env = "gnu", any(target_arch = "mips64", target_arch = "mips64r6")), link_name = "cfgetospeed@GLIBC_2.0")]
#[cfg_attr(all(target_env = "gnu", target_arch = "powerpc64", target_endian = "big"), link_name = "cfgetospeed@GLIBC_2.3")]
#[cfg_attr(all(target_env = "gnu", target_arch = "powerpc64", target_endian = "little"), link_name = "cfgetospeed@GLIBC_2.17")]
#[cfg_attr(all(target_env = "gnu", target_arch = "riscv64"), link_name = "cfgetospeed@GLIBC_2.27")]
#[cfg_attr(all(target_env = "gnu", target_arch = "s390x"), link_name = "cfgetospeed@GLIBC_2.2")]
#[cfg_attr(all(target_env = "gnu", target_arch = "sparc64"), link_name = "cfgetospeed@GLIBC_2.2")]
#[cfg_attr(all(target_env = "gnu", target_arch = "x86_64", target_pointer_width = "64"), link_name = "cfgetospeed@GLIBC_2.2.5")]
#[cfg_attr(all(target_env = "gnu", target_arch = "x86_64", target_pointer_width = "32"), link_name = "cfgetospeed@GLIBC_2.16")]
pub fn cfgetospeed(termios: *const crate::termios) -> crate::speed_t;
#[cfg_attr(all(target_env = "gnu", target_arch = "arm"), link_name = "cfsetispeed@GLIBC_2.4")]
#[cfg_attr(all(target_env = "gnu", target_arch = "csky"), link_name = "cfsetispeed@GLIBC_2.29")]
#[cfg_attr(all(target_env = "gnu", target_arch = "m68k"), link_name = "cfsetispeed@GLIBC_2.0")]
#[cfg_attr(all(target_env = "gnu", any(target_arch = "mips", target_arch = "mips32r6")), link_name = "cfsetispeed@GLIBC_2.0")]
#[cfg_attr(all(target_env = "gnu", target_arch = "powerpc"), link_name = "cfsetispeed@GLIBC_2.0")]
#[cfg_attr(all(target_env = "gnu", target_arch = "riscv32"), link_name = "cfsetispeed@GLIBC_2.33")]
#[cfg_attr(all(target_env = "gnu", target_arch = "sparc"), link_name = "cfsetispeed@GLIBC_2.0")]
#[cfg_attr(all(target_env = "gnu", target_arch = "x86"), link_name = "cfsetispeed@GLIBC_2.0")]
#[cfg_attr(all(target_env = "gnu", target_arch = "aarch64"), link_name = "cfsetispeed@GLIBC_2.17")]
#[cfg_attr(all(target_env = "gnu", target_arch = "loongarch64"), link_name = "cfsetispeed@GLIBC_2.36")]
#[cfg_attr(all(target_env = "gnu", any(target_arch = "mips64", target_arch = "mips64r6")), link_name = "cfsetispeed@GLIBC_2.0")]
#[cfg_attr(all(target_env = "gnu", target_arch = "powerpc64", target_endian = "big"), link_name = "cfsetispeed@GLIBC_2.3")]
#[cfg_attr(all(target_env = "gnu", target_arch = "powerpc64", target_endian = "little"), link_name = "cfsetispeed@GLIBC_2.17")]
#[cfg_attr(all(target_env = "gnu", target_arch = "riscv64"), link_name = "cfsetispeed@GLIBC_2.27")]
#[cfg_attr(all(target_env = "gnu", target_arch = "s390x"), link_name = "cfsetispeed@GLIBC_2.2")]
#[cfg_attr(all(target_env = "gnu", target_arch = "sparc64"), link_name = "cfsetispeed@GLIBC_2.2")]
#[cfg_attr(all(target_env = "gnu", target_arch = "x86_64", target_pointer_width = "64"), link_name = "cfsetispeed@GLIBC_2.2.5")]
#[cfg_attr(all(target_env = "gnu", target_arch = "x86_64", target_pointer_width = "32"), link_name = "cfsetispeed@GLIBC_2.16")]
pub fn cfsetispeed(termios: *mut crate::termios, speed: crate::speed_t) -> c_int;
#[cfg_attr(all(target_env = "gnu", target_arch = "arm"), link_name = "cfsetospeed@GLIBC_2.4")]
#[cfg_attr(all(target_env = "gnu", target_arch = "csky"), link_name = "cfsetospeed@GLIBC_2.29")]
#[cfg_attr(all(target_env = "gnu", target_arch = "m68k"), link_name = "cfsetospeed@GLIBC_2.0")]
#[cfg_attr(all(target_env = "gnu", any(target_arch = "mips", target_arch = "mips32r6")), link_name = "cfsetospeed@GLIBC_2.0")]
#[cfg_attr(all(target_env = "gnu", target_arch = "powerpc"), link_name = "cfsetospeed@GLIBC_2.0")]
#[cfg_attr(all(target_env = "gnu", target_arch = "riscv32"), link_name = "cfsetospeed@GLIBC_2.33")]
#[cfg_attr(all(target_env = "gnu", target_arch = "sparc"), link_name = "cfsetospeed@GLIBC_2.0")]
#[cfg_attr(all(target_env = "gnu", target_arch = "x86"), link_name = "cfsetospeed@GLIBC_2.0")]
#[cfg_attr(all(target_env = "gnu", target_arch = "aarch64"), link_name = "cfsetospeed@GLIBC_2.17")]
#[cfg_attr(all(target_env = "gnu", target_arch = "loongarch64"), link_name = "cfsetospeed@GLIBC_2.36")]
#[cfg_attr(all(target_env = "gnu", any(target_arch = "mips64", target_arch = "mips64r6")), link_name = "cfsetospeed@GLIBC_2.0")]
#[cfg_attr(all(target_env = "gnu", target_arch = "powerpc64", target_endian = "big"), link_name = "cfsetospeed@GLIBC_2.3")]
#[cfg_attr(all(target_env = "gnu", target_arch = "powerpc64", target_endian = "little"), link_name = "cfsetospeed@GLIBC_2.17")]
#[cfg_attr(all(target_env = "gnu", target_arch = "riscv64"), link_name = "cfsetospeed@GLIBC_2.27")]
#[cfg_attr(all(target_env = "gnu", target_arch = "s390x"), link_name = "cfsetospeed@GLIBC_2.2")]
#[cfg_attr(all(target_env = "gnu", target_arch = "sparc64"), link_name = "cfsetospeed@GLIBC_2.2")]
#[cfg_attr(all(target_env = "gnu", target_arch = "x86_64", target_pointer_width = "64"), link_name = "cfsetospeed@GLIBC_2.2.5")]
#[cfg_attr(all(target_env = "gnu", target_arch = "x86_64", target_pointer_width = "32"), link_name = "cfsetospeed@GLIBC_2.16")]
...
#[cfg_attr(all(target_env = "gnu", target_arch = "sparc64"), link_name = "tcgetattr@GLIBC_2.2")]
...
#[cfg_attr(all(target_env = "gnu", target_arch = "sparc64"), link_name = "tcsetattr@GLIBC_2.2")]
...
cfg_if! {
    if #[cfg(any(
        ...
        extern "C" {
#[cfg(not(target_os = "l4re"))]
#[cfg_attr(all(target_env = "gnu", target_arch = "arm"), link_name = "cfsetspeed@GLIBC_2.4")]
#[cfg_attr(all(target_env = "gnu", target_arch = "csky"), link_name = "cfsetspeed@GLIBC_2.29")]
#[cfg_attr(all(target_env = "gnu", target_arch = "m68k"), link_name = "cfsetspeed@GLIBC_2.0")]
#[cfg_attr(all(target_env = "gnu", any(target_arch = "mips", target_arch = "mips32r6")), link_name = "cfsetspeed@GLIBC_2.0")]
#[cfg_attr(all(target_env = "gnu", target_arch = "powerpc"), link_name = "cfsetspeed@GLIBC_2.0")]
#[cfg_attr(all(target_env = "gnu", target_arch = "riscv32"), link_name = "cfsetspeed@GLIBC_2.33")]
#[cfg_attr(all(target_env = "gnu", target_arch = "sparc"), link_name = "cfsetspeed@GLIBC_2.0")]
#[cfg_attr(all(target_env = "gnu", target_arch = "x86"), link_name = "cfsetspeed@GLIBC_2.0")]
#[cfg_attr(all(target_env = "gnu", target_arch = "aarch64"), link_name = "cfsetspeed@GLIBC_2.17")]
#[cfg_attr(all(target_env = "gnu", target_arch = "loongarch64"), link_name = "cfsetspeed@GLIBC_2.36")]
#[cfg_attr(all(target_env = "gnu", any(target_arch = "mips64", target_arch = "mips64r6")), link_name = "cfsetspeed@GLIBC_2.0")]
#[cfg_attr(all(target_env = "gnu", target_arch = "powerpc64", target_endian = "big"), link_name = "cfsetspeed@GLIBC_2.3")]
#[cfg_attr(all(target_env = "gnu", target_arch = "powerpc64", target_endian = "little"), link_name = "cfsetspeed@GLIBC_2.17")]
#[cfg_attr(all(target_env = "gnu", target_arch = "riscv64"), link_name = "cfsetspeed@GLIBC_2.27")]
#[cfg_attr(all(target_env = "gnu", target_arch = "s390x"), link_name = "cfsetspeed@GLIBC_2.2")]
#[cfg_attr(all(target_env = "gnu", target_arch = "sparc64"), link_name = "cfsetspeed@GLIBC_2.2")]
#[cfg_attr(all(target_env = "gnu", target_arch = "x86_64", target_pointer_width = "64"), link_name = "cfsetspeed@GLIBC_2.2.5")]
#[cfg_attr(all(target_env = "gnu", target_arch = "x86_64", target_pointer_width = "32"), link_name = "cfsetspeed@GLIBC_2.16")]
pub fn cfsetspeed(termios: *mut crate::termios, speed: crate::speed_t) -> c_int;
        }
    }
}
