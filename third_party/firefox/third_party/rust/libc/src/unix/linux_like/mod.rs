...
s_no_extra_traits! {
#[cfg_attr(any(target_arch = "x86_64", all(target_arch = "x86", target_env = "gnu")), repr(packed))]
...
#[cfg_attr(any(gnu_time_bits64, musl_redir_time64), link_name = "__clock_gettime64")]
pub fn clock_gettime(clk_id: crate::clockid_t, tp: *mut crate::timespec) -> c_int;
#[cfg_attr(any(gnu_time_bits64, musl_redir_time64), link_name = "__clock_settime64")]
