...
#[cfg(all(not(gnu_file_offset_bits64), not(target_arch = "x86_64"), target_pointer_width = "32"))]
...
#[cfg(not(any(target_arch = "sparc", target_arch = "sparc64", target_arch = "mips", target_arch = "mips32r6", target_arch = "mips64", target_arch = "mips64r6")))]
...
#[cfg(any(target_arch = "aarch64", target_arch = "s390x", target_arch = "loongarch64", all(target_pointer_width = "32", not(target_arch = "x86_64"))))]
pub ut_session: c_long,
#[cfg(any(target_arch = "aarch64", target_arch = "s390x", target_arch = "loongarch64", all(target_pointer_width = "32", not(target_arch = "x86_64"))))]
pub ut_tv: crate::timeval,

#[cfg(not(any(target_arch = "aarch64", target_arch = "s390x", target_arch = "loongarch64", all(target_pointer_width = "32", not(target_arch = "x86_64")))))]
pub ut_session: i32,
#[cfg(not(any(target_arch = "aarch64", target_arch = "s390x", target_arch = "loongarch64", all(target_pointer_width = "32", not(target_arch = "x86_64")))))]
pub ut_tv: __timeval,
...
#[cfg_attr(all(target_pointer_width = "32", gnu_time_bits64), link_name = "__pthread_timedjoin_np64")]
