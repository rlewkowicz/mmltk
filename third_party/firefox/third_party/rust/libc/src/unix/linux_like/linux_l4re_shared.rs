...
#[cfg_attr(any(musl_redir_time64, gnu_time_bits64), link_name = "__aio_suspend_time64")]
pub fn aio_suspend(
...
extern "C" {
#[cfg_attr(not(any(target_env = "musl", target_env = "ohos")), link_name = "__xpg_strerror_r")]
...
#[cfg_attr(all(not(gnu_time_bits64), gnu_file_offset_bits64), link_name = "glob64")]
pub fn glob(
...
#[cfg_attr(all(not(gnu_time_bits64), gnu_file_offset_bits64), link_name = "globfree64")]
...
#[cfg_attr(any(gnu_time_bits64, musl_redir_time64), link_name = "__timer_gettime64")]
