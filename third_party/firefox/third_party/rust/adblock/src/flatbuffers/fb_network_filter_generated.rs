...
pub mod fb {
    ...
    impl<'a> Default for NetworkFilterListArgs<'a> {
        ...
        fn default() -> Self {
            NetworkFilterListArgs {
                filter_map_index: None,  
                filter_map_values: None, 
            }
        }
    }
    ...
    impl<'a> Default for CosmeticFiltersArgs<'a> {
        ...
        fn default() -> Self {
            CosmeticFiltersArgs {
                simple_class_rules: None,            
                simple_id_rules: None,               
                misc_generic_selectors: None,        
                complex_class_rules_index: None,     
                complex_class_rules_values: None,    
                complex_id_rules_index: None,        
                complex_id_rules_values: None,       
                hostname_hide_index: None,           
                hostname_hide_values: None,          
                hostname_inject_script_index: None,  
                hostname_inject_script_values: None, 
                hostname_index: None,                
                hostname_values: None,               
            }
        }
    }
