...
#[cfg(not(all(target_arch = "wasm64", target_os = "unknown")))]
...
#[cfg(all(target_arch = "wasm64", target_os = "unknown", feature = "js"))]
fn random_seed() -> Option<u64> {
    let mut seed = [0u8; 8];
...
#[cfg(all(target_arch = "wasm64", target_os = "unknown", not(feature = "js")))]
fn random_seed() -> Option<u64> {
    None
}
