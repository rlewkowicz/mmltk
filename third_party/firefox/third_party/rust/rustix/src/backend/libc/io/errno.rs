...
pub const CHILD: Self = Self(c::ECHILD);
    /// `ECHRNG`
#[cfg(not(any(bsd, target_os = "espidf", target_os = "horizon", target_os = "hurd", target_os = "l4re", target_os = "vita", target_os = "wasi")))]
...
pub const NOTDIR: Self = Self(c::ENOTDIR);
    ...
    /// `ENOTRECOVERABLE`
#[cfg(not(any(freebsdlike, netbsdlike, target_os = "l4re")))]
...
pub const RANGE: Self = Self(c::ERANGE);
    ...
    /// `EREMOTE`
#[cfg(not(any(target_os = "espidf", target_os = "horizon", target_os = "l4re", target_os = "vita", target_os = "wasi")))]
...
pub const SRCH: Self = Self(c::ESRCH);
    ...
    /// `ETIME`
#[cfg(not(any(freebsdlike, target_os = "l4re", target_os = "wasi")))]
