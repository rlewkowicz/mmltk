...
#[cfg(any(linux_kernel, target_os = "fuchsia", target_os = "redox", target_env = "newlib"))]
...
#[cfg(not(any(apple, target_os = "nto")))]
use c::TCP_KEEPIDLE;
...
#[cfg(not(any(bsd, solarish, target_os = "l4re", target_os = "nto")))]
use c::IPV6_ADD_MEMBERSHIP;
#[cfg(any(bsd, solarish, target_os = "l4re", target_os = "nto"))]
...
#[cfg(any(bsd, linux_like, target_os = "aix", target_os = "fuchsia", target_os = "nto", target_env = "newlib"))]
#[inline]
...
#[cfg(any(bsd, linux_like, target_os = "aix", target_os = "fuchsia", target_os = "nto"))]
#[inline]
