...
#[cfg(not(any(apple, target_os = "espidf", target_os = "redox", target_os = "vita", target_os = "wasi")))]
...
#[cfg(any(target_arch = "aarch64", target_arch = "riscv32", target_arch = "riscv64", target_arch = "csky", target_arch = "loongarch64"))]
{
        openat_via_syscall(CWD, path, oflags, mode)
    }

#[cfg(not(any(target_arch = "aarch64", target_arch = "riscv32", target_arch = "riscv64", target_arch = "csky", target_arch = "loongarch64")))]
unsafe {
        syscall! {
            fn open(
...
#[cfg(all(target_env = "gnu", not(target_os = "hurd")))]
...
#[cfg(all(linux_kernel, any(target_pointer_width = "32", target_arch = "mips64", target_arch = "mips64r6")))]
{
...
#[cfg(not(all(linux_kernel, any(target_pointer_width = "32", target_arch = "mips64", target_arch = "mips64r6"))))]
unsafe {
#[cfg(any())]
...
#[cfg(not(any(target_os = "espidf", target_os = "horizon", target_os = "emscripten", target_os = "vita")))]
pub(crate) fn access(path: &CStr, access: Access) -> io::Result<()> {
    unsafe { ret(c::access(c_str(path), access.bits())) }
}

#[cfg(not(any(target_os = "emscripten", target_os = "espidf", target_os = "horizon", target_os = "redox", target_os = "vita")))]
...
#[cfg(not(any(target_os = "espidf", target_os = "horizon", target_os = "redox", target_os = "vita")))]
...
#[cfg(not(any(linux_kernel, target_os = "espidf", target_os = "redox", target_os = "wasi")))]
...
#[cfg(not(any(apple, target_os = "espidf", target_os = "horizon", target_os = "redox", target_os = "vita", target_os = "wasi")))]
...
#[cfg(not(any(target_os = "espidf", target_os = "horizon", target_os = "redox", target_os = "vita", target_os = "wasi")))]
pub(crate) fn sync() {
    unsafe { c::sync() }
}
