...
#[cfg(not(any(target_os = "aix", target_os = "cygwin", target_os = "espidf", target_os = "horizon", target_os = "wasi", target_os = "vita", solarish)))]
...
#[cfg(not(any(solarish, target_os = "aix", target_os = "espidf", target_os = "nto", target_os = "redox", target_os = "vita")))]
#[inline]
...
#[cfg(not(any(netbsdlike, target_os = "espidf", target_os = "horizon", target_os = "nto", target_os = "redox", target_os = "vita")))]
bitflags! {
...
bitflags! {
    ...
    pub struct StatVfsMountFlags: u64 {
        ...
        /// `ST_NODEV`
#[cfg(any(linux_kernel, target_os = "aix", target_os = "emscripten", target_os = "fuchsia"))]
...
/// `__fsword_t`
#[cfg(all(target_arch = "s390x", target_env = "gnu"))]
pub type FsWord = u32;

/// `__fsword_t`
#[cfg(all(target_arch = "s390x", target_env = "musl"))]
pub type FsWord = u64;
