...
#[cfg(all(fix_y2038, not(any(apple, target_os = "emscripten", target_os = "horizon", target_os = "vita"))))]
...
#[cfg(all(target_pointer_width = "32", not(any(target_arch = "aarch64", target_arch = "x86_64"))))]
{
