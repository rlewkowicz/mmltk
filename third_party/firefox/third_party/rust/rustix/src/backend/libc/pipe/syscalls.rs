...
use crate::io;
#[cfg(not(any(apple, target_os = "aix", target_os = "espidf", target_os = "nto", target_os = "wasi")))]
...
#[cfg(not(any(apple, target_os = "aix", target_os = "espidf", target_os = "horizon", target_os = "nto", target_os = "wasi")))]
