#[cfg(not(any(solarish, target_os = "aix", target_os = "nto", target_os = "vita")))]
...
#[cfg(any(linux_like, solarish, target_os = "fuchsia", target_os = "hermit", target_os = "redox"))]
d_off: dirent.d_off,
    ...
    /// `fstatvfs(self)`
#[cfg(not(any(solarish, target_os = "horizon", target_os = "vita", target_os = "wasi")))]
#[inline]
    ...
    /// `fchdir(self)`
    #[cfg(feature = "process")]
#[cfg(not(any(target_os = "fuchsia", target_os = "horizon", target_os = "vita", target_os = "wasi")))]
