...
#[cfg(any(target_pointer_width = "32", target_arch = "mips64", target_arch = "mips64r6"))]
{
...
#[cfg(all(target_pointer_width = "64", not(target_arch = "mips64"), not(target_arch = "mips64r6")))]
unsafe {
