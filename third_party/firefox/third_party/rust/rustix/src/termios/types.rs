...
#[cfg(any(linux_like, target_env = "newlib", target_os = "fuchsia", target_os = "redox"))]
...
#[cfg(not(any(linux_kernel, bsd, solarish, all(libc, target_env = "newlib"), target_os = "aix")))]
{
...
bitflags! {
    ...
    pub struct InputModes: types::tcflag_t {
        ...
        /// `IUCLC`
#[cfg(any(linux_raw_dep, solarish, target_os = "aix", target_os = "nto"))]
const IUCLC = c::IUCLC;
...
bitflags! {
    ...
    pub struct LocalModes: types::tcflag_t {
        /// `XCASE`
#[cfg(any(linux_raw_dep, target_arch = "s390x"))]
const XCASE = c::XCASE;
...
pub mod speed {
    ...
    /// `B460800`
#[cfg(not(any(apple, target_os = "aix")))]
pub const B460800: u32 = 460_800;

    /// `B500000`
#[cfg(not(any(bsd, solarish, target_os = "aix")))]
...
#[cfg(not(any(bsd, all(linux_kernel, any(target_arch = "powerpc", target_arch = "powerpc64")))))]
...
#[cfg(not(any(apple, target_os = "aix", target_os = "nto")))]
c::B460800 => Some(460_800),
#[cfg(not(any(bsd, solarish, target_os = "aix", target_os = "nto")))]
c::B500000 => Some(500_000),
#[cfg(not(any(bsd, solarish, target_os = "aix", target_os = "nto")))]
c::B576000 => Some(576_000),
#[cfg(not(any(apple, target_os = "aix", target_os = "nto")))]
c::B921600 => Some(921_600),
#[cfg(not(any(bsd, target_os = "aix", target_os = "nto")))]
