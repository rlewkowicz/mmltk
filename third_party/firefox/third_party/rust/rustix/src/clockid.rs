...
#[cfg_attr(not(any(target_os = "aix", target_os = "cygwin")), repr(i32))]
#[cfg_attr(target_os = "cygwin", repr(u64))]
...
#[cfg(not(any(solarish, target_os = "horizon", target_os = "redox", target_os = "vita")))]
