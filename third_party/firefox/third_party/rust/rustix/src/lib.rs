...
#[cfg(any(all(linux_raw, feature = "use-libc-auxv"), all(libc, not(any(target_os = "espidf", target_os = "wasi")))))]
#[macro_use]
mod weak;
...
#[cfg_attr(docsrs, doc(cfg(any(feature = "fs", feature = "mount", feature = "net"))))]
pub mod path;
#[cfg(feature = "pipe")]
...
mod kernel_sigset;
#[cfg(not(target_os = "wasi"))]
#[cfg(any(feature = "process", feature = "runtime", feature = "termios", feature = "thread", all(bsd, feature = "event"), all(linux_kernel, feature = "net")))]
mod pid;
#[cfg(any(feature = "process", feature = "thread"))]
#[cfg(linux_kernel)]
mod prctl;
#[cfg(not(any(target_os = "espidf", target_os = "wasi")))]
#[cfg(any(feature = "io_uring", feature = "process", feature = "runtime", all(bsd, feature = "event")))]
mod signal;
#[cfg(any(
    feature = "fs",
    feature = "event",
