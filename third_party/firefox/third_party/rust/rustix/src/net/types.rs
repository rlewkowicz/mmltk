...
pub const DLI: Self = Self(c::AF_DLI as _);
    ...
    /// `AF_ECMA`
#[cfg(any(apple, freebsdlike, solarish, target_os = "aix", target_os = "nto"))]
...
pub const LINK: Self = Self(c::AF_LINK as _);
    /// `AF_MPLS`
#[cfg(any(netbsdlike, target_os = "emscripten", target_os = "fuchsia"))]
pub const MPLS: Self = Self(c::AF_MPLS as _);
    ...
    /// `AF_ROUTE`
#[cfg(any(bsd, solarish, target_os = "emscripten", target_os = "fuchsia", target_os = "nto"))]
...
pub mod ipproto {
    ...
    /// `IPPROTO_IGMP`
#[cfg(not(any(solarish, target_os = "espidf", target_os = "horizon", target_os = "vita")))]
pub const IGMP: Protocol = Protocol(new_raw_protocol(c::IPPROTO_IGMP as _));
    /// `IPPROTO_IPIP`
#[cfg(not(any(solarish, target_os = "espidf", target_os = "horizon", target_os = "redox", target_os = "vita")))]
