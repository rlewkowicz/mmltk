...
#[cfg(all(feature = "std", target_os = "wasi", any(not(target_env = "p2"), wasip2)))]
    ...
    F: FnOnce(&CStr) -> io::Result<T>,
{
    ...
    {
#[cfg(all(libc, not(any(target_os = "espidf", target_os = "horizon", target_os = "hurd", target_os = "vita", target_os = "wasi"))))]
...
#[cfg(any(target_os = "espidf", target_os = "horizon", target_os = "hurd", target_os = "vita", target_os = "wasi"))]
