...
#[cfg(all(feature = "all", not(any(target_os = "redox", target_os = "espidf", target_os = "wasi"))))]
...
#[cfg(not(any(target_os = "nto", target_os = "vita")))]
...
#[cfg(all(feature = "all", not(any(target_os = "illumos", target_os = "cygwin", target_os = "wasi"))))]
