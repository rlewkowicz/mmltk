...
#[cfg_attr(docsrs, doc(cfg(all(feature = "parsing", any(feature = "full", feature = "derive")))))]
pub mod meta;
...
#[cfg(all(any(feature = "full", feature = "derive"), any(feature = "parsing", feature = "printing")))]
mod precedence;
