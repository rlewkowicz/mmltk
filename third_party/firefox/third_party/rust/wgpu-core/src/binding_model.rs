    ...
    <[TLAS] as ToOwned>::Owned: fmt::Debug,
{
    ...
    pub binding: u32,
#[cfg_attr(feature = "serde", serde(bound(deserialize = "BindingResource<'a, B, S, TV, TLAS, ET>: Deserialize<'de>")))]
...
#[cfg_attr(feature = "serde", serde(bound(deserialize = "<[Option<BGL>] as ToOwned>::Owned: Deserialize<'de>")))]
...
#[cfg_attr(feature = "serde", serde(bound(deserialize = "<[BufferBinding<B>] as ToOwned>::Owned: Deserialize<'de>")))]
BufferArray(Cow<'a, [BufferBinding<B>]>),
    Sampler(S),
#[cfg_attr(feature = "serde", serde(bound(deserialize = "<[S] as ToOwned>::Owned: Deserialize<'de>")))]
SamplerArray(Cow<'a, [S]>),
    TextureView(TV),
#[cfg_attr(feature = "serde", serde(bound(deserialize = "<[TV] as ToOwned>::Owned: Deserialize<'de>")))]
TextureViewArray(Cow<'a, [TV]>),
    AccelerationStructure(TLAS),
#[cfg_attr(feature = "serde", serde(bound(deserialize = "<[TLAS] as ToOwned>::Owned: Deserialize<'de>")))]
