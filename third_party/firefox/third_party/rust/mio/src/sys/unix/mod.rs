...
cfg_os_poll! {
#[cfg_attr(all(
        not(mio_unsupported_force_poll_poll), any(
            target_os = "android",
            target_os = "illumos",
            target_os = "linux",
            target_os = "redox",
...
#[cfg_attr(any(
        mio_unsupported_force_poll_poll, target_os = "aix",
        target_os = "espidf",
        target_os = "fuchsia",
        target_os = "haiku",
        target_os = "hermit",
...
#[cfg_attr(all(
        not(mio_unsupported_force_waker_pipe), any(
            target_os = "android",
            target_os = "espidf",
            target_os = "fuchsia",
            target_os = "hermit",
...
#[cfg_attr(all(
        not(mio_unsupported_force_waker_pipe), not(mio_unsupported_force_poll_poll), 
        any(
            target_os = "freebsd",
            target_os = "ios",
            target_os = "macos",
...
#[cfg_attr(any(
        mio_unsupported_force_waker_pipe, all(
