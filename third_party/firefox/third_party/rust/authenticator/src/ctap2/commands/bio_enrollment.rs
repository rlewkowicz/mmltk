...
struct BioEnrollmentParams {
    template_id: Option<BioTemplateId>,     
        ...
        D: Deserializer<'de>,
    {
        ...
        impl<'de> Visitor<'de> for BioEnrollmentResponseVisitor {
                ...
                M: MapAccess<'de>,
            {
                ...
                let mut fingerprint_kind = None; 
                let mut max_capture_samples_required_for_enroll = None; 
                let mut template_id = None; 
                let mut last_enroll_sample_status = None; 
                let mut remaining_samples = None; 
                let mut template_infos = None; 
                let mut max_template_friendly_name = None; 
