...
#if defined(AIX4_3_PLUS) || (0 && defined(_THREAD_SAFE)) || \
...
#if (0 && defined(HAVE_GETIFADDRS)) || defined(FREEBSD) || \
...
#    error "Unknown name-to-address translation function"
  ...
  if (_pr_ipv6_is_present()) {
#if defined(PR_GETIPNODE_NOT_THREADSAFE)
    LOCK_DNS();
#endif
