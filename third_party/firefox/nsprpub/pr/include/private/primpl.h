...
#if !0 \
        && !(0 && defined(_PR_GLOBAL_THREADS_ONLY))
...
#if !defined(_MD_MINIMUM_STACK_SIZE)
...
#if !defined(_PR_LOCAL_THREADS_ONLY)
#if defined(HAVE_CVAR_BUILT_ON_SEM)
...
struct PRFilePrivate {
    ...
    PRFileDesc *next;
    PRIntn lockCount;   
#if defined(_PR_HAVE_PEEK_BUFFER)
    char *peekBuffer;
    PRInt32 peekBufSize;
    PRInt32 peekBytes;
#endif
