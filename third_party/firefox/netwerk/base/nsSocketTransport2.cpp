...
#if defined(ENABLE_SOCKET_TRACING)
...
void nsSocketTransport::OnSocketReady(PRFileDesc* fd, int16_t outFlags) {
  ...
  if (mPollFlags == PR_POLL_EXCEPT) mPollFlags = 0;  
}
