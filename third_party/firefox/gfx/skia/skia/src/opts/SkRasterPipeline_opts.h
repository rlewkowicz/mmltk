...
#if !defined(SkRasterPipeline_opts_DEFINED)
...
#define HIGHP_STAGE(name, arg) \
    DECLARE_HIGHP_STAGE(name, arg, void, ++program, , )

#define HIGHP_TAIL_STAGE(name, arg) \
    DECLARE_HIGHP_STAGE(name, arg, void, ++program, , SKRP_MUSTTAIL)

#define HIGHP_BRANCH_STAGE(name, arg) \
    DECLARE_HIGHP_STAGE(name, arg, int, , program +=, SKRP_MUSTTAIL)
