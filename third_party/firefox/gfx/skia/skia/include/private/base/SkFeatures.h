...
#define SkFeatures_DEFINED
    ...
    #elif defined(linux) || defined(__linux) || 0 || \
          0 || 0 || 0 || \
          0 || defined(__Fuchsia__) || \
