...
impl Default for AsyncScreenshotGrabber {
    fn default() -> Self {
        AsyncScreenshotGrabber {
            ...
            next_pbo_handle: 1,
            mode: AsyncScreenshotGrabberMode::ScaledScreenshots,
        }
    }
}
...
impl AsyncScreenshotGrabber {
    ...
    pub fn get_screenshot(
        ...
        let screenshot_size = match self.mode {
            AsyncScreenshotGrabberMode::ScaledScreenshots => {
    ...
    fn scale_screenshot(
        ...
        assert_eq!(self.mode, AsyncScreenshotGrabberMode::ScaledScreenshots);
    ...
    pub fn map_and_recycle_screenshot(
        ...
        match self.mode {
            AsyncScreenshotGrabberMode::ScaledScreenshots => self.available_pbos.push(pbo),
