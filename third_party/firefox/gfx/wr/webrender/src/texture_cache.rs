...
impl BudgetType {
    ...
    const PRESSURE_COUNTERS: [usize; BudgetType::COUNT] = [
        render_stats::ATLAS_COLOR8_LINEAR_PRESSURE,
        render_stats::ATLAS_COLOR8_NEAREST_PRESSURE,
        render_stats::ATLAS_COLOR8_GLYPHS_PRESSURE,
        render_stats::ATLAS_ALPHA8_PRESSURE,
        render_stats::ATLAS_ALPHA8_GLYPHS_PRESSURE,
        render_stats::ATLAS_ALPHA16_PRESSURE,
        render_stats::ATLAS_STANDALONE_PRESSURE,
    ];
...
pub fn set_debug_flags(&mut self, flags: DebugFlags) {
    ...
    pub fn end_frame(&mut self, profile: &mut TransactionProfile) {
        ...
        profile.set(render_stats::ATLAS_A8_PIXELS, self.shared_textures.alpha8_linear.allocated_space());
        profile.set(render_stats::ATLAS_A8_TEXTURES, self.shared_textures.alpha8_linear.allocated_textures());
        profile.set(render_stats::ATLAS_A8_GLYPHS_PIXELS, self.shared_textures.alpha8_glyphs.allocated_space());
        profile.set(render_stats::ATLAS_A8_GLYPHS_TEXTURES, self.shared_textures.alpha8_glyphs.allocated_textures());
        profile.set(render_stats::ATLAS_A16_PIXELS, self.shared_textures.alpha16_linear.allocated_space());
        profile.set(render_stats::ATLAS_A16_TEXTURES, self.shared_textures.alpha16_linear.allocated_textures());
        profile.set(render_stats::ATLAS_RGBA8_LINEAR_PIXELS, self.shared_textures.color8_linear.allocated_space());
        profile.set(render_stats::ATLAS_RGBA8_LINEAR_TEXTURES, self.shared_textures.color8_linear.allocated_textures());
        profile.set(render_stats::ATLAS_RGBA8_NEAREST_PIXELS, self.shared_textures.color8_nearest.allocated_space());
        profile.set(render_stats::ATLAS_RGBA8_NEAREST_TEXTURES, self.shared_textures.color8_nearest.allocated_textures());
        profile.set(render_stats::ATLAS_RGBA8_GLYPHS_PIXELS, self.shared_textures.color8_glyphs.allocated_space());
        profile.set(render_stats::ATLAS_RGBA8_GLYPHS_TEXTURES, self.shared_textures.color8_glyphs.allocated_textures());
        ...
        profile.set(render_stats::ATLAS_ITEMS_MEM, render_stats::bytes_to_mb(shared_bytes));
    ...
    fn evict_items_from_cache_if_required(&mut self, profile: &mut TransactionProfile) {
        ...
        if eviction_count > 0 {
            profile.set(render_stats::TEXTURE_CACHE_EVICTION_COUNT, eviction_count);
            profile.set(
                render_stats::TEXTURE_CACHE_YOUNGEST_EVICTION,
