...
impl FrameBuilder {
    ...
    fn build_layer_screen_rects_and_cull_layers(
        ...
        {
            profile.start_time(render_stats::FRAME_VISIBILITY_TIME);
            ...
            profile.end_time(render_stats::FRAME_VISIBILITY_TIME);
        }
        ...
        profile.start_time(render_stats::FRAME_PREPARE_TIME);
        ...
        profile.end_time(render_stats::FRAME_PREPARE_TIME);
        profile.set(render_stats::VISIBLE_PRIMITIVES, frame_state.num_visible_primitives);
    ...
    pub fn build(
        ...
        profile.set(render_stats::PRIMITIVES, scene.prim_instances.len());
        profile.set(render_stats::PICTURE_CACHE_SLICES, scene.tile_cache_config.picture_cache_slice_count);
        scratch.begin_frame();
        ...
        profile.start_time(render_stats::FRAME_BATCHING_TIME);
        ...
        profile.end_time(render_stats::FRAME_BATCHING_TIME);
