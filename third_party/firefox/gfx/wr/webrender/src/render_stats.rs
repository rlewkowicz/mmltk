...
use glyph_rasterizer::timing::GlyphRasterizeTiming;
...
pub fn add_text_marker(_label: &str, _text: &str, _duration: Duration) {}
pub fn add_event_marker(_label: &str) {}
pub fn thread_is_being_profiled() -> bool { false }
...
impl GlyphRasterizeTiming for TransactionProfile {
