...
pub extern "C" fn wr_window_new(
    ...
    let gl = unsafe {
        if gl_context.is_null() {
            panic!("Native GL context required");
    ...
    let enable_dithering = static_prefs::pref!("gfx.webrender.dithering");
