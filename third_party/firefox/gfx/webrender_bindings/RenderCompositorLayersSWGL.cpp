...
class WindowLMC : public frame_capture::Window {
 public:
...
class RenderSourceLMC : public frame_capture::RenderSource {
 public:
...
class DownscaleTargetLMC : public frame_capture::DownscaleTarget {
 public:
  explicit DownscaleTargetLMC(CompositingRenderTarget* aRT,
                              Compositor* aCompositor)
      : frame_capture::DownscaleTarget(aRT->GetSize()),
...
class AsyncReadbackBufferLMC
 ...
 public:
  AsyncReadbackBufferLMC(mozilla::layers::AsyncReadbackBuffer* aARB,
                         Compositor* aCompositor)
      : frame_capture::AsyncReadbackBuffer(aARB->GetSize()),
        mARB(aARB),
        mCompositor(aCompositor) {}
