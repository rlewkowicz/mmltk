...
#if !defined(INCLUDE_GLES2_GL2EXT_ANGLE_H_)
#define INCLUDE_GLES2_GL2EXT_ANGLE_H_

// clang-format off

#if !defined(GL_ANGLE_client_arrays)
#define GL_ANGLE_client_arrays 1
#define GL_CLIENT_ARRAYS_ANGLE 0x93AA
#endif

#if !defined(GL_ANGLE_request_extension)
...
#if !defined(GL_ANGLE_robust_resource_initialization)
...
#if !defined(GL_ANGLE_polygon_mode)
...
#if !defined(GL_ANGLE_provoking_vertex)
...
#if !defined(GL_ANGLE_clip_cull_distance)
...
#if !defined(GL_CHROMIUM_bind_generates_resource)
#define GL_CHROMIUM_bind_generates_resource 1
#define GL_BIND_GENERATES_RESOURCE_CHROMIUM 0x9244
#endif

#if !defined(GL_ANGLE_memory_size)
...
#if !defined(GL_CHROMIUM_copy_texture)
...
#if !defined(GL_CHROMIUM_compressed_copy_texture)
...
#if !defined(GL_ANGLE_copy_texture_3d)
...
#if !defined(GL_ANGLE_lossy_etc_decode)
...
#if !defined(GL_ANGLE_robust_client_memory)
...
#if !defined(GL_ANGLE_texture_multisample)
...
#if !defined(GL_ANGLE_get_tex_level_parameter)
...
#if !defined(GL_ANGLE_base_vertex_base_instance)
...
#if !defined(GL_CHROMIUM_bind_uniform_location)
...
#if !defined(GL_CHROMIUM_lose_context)
...
#if !defined(GL_ANGLE_texture_external_update)
...
#if !defined(GL_ANGLE_memory_object_fuchsia)
...
#if !defined(GL_ANGLE_semaphore_fuchsia)
...
#if !defined(GL_ANGLE_vulkan_image)
...
#if !defined(GL_NV_robustness_video_memory)
#define GL_NV_robustness_video_memory
#define GL_PURGED_CONTEXT_RESET_NV 0x92BB
#endif

#if !defined(GL_ANGLE_get_serialized_context_string)
#define GL_ANGLE_get_serialized_context_string
#define GL_SERIALIZED_CONTEXT_STRING_ANGLE 0x96B0
#endif

#if !defined(GL_ANGLE_robust_fragment_shader_output)
...
#if !defined(GL_ANGLE_yuv_internal_format)
...
#if !defined(GL_ANGLE_rgbx_internal_format)
...
#if !defined(GL_ANGLE_shader_binary)
