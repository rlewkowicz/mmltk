...
#if !defined(EGL_ANGLE_direct_composition)
...
#if !defined(EGL_ANGLE_platform_angle_d3d_luid)
...
#if !defined(EGL_ANGLE_platform_angle_d3d11on12)
...
#if !defined(EGL_ANGLE_platform_angle_null)
#define EGL_ANGLE_platform_angle_null 1
#define EGL_PLATFORM_ANGLE_TYPE_NULL_ANGLE 0x33AE
#endif

#if !defined(EGL_ANGLE_platform_angle_webgpu)
...
#if !defined(EGL_ANGLE_platform_angle_vulkan)
...
#if !defined(EGL_ANGLE_platform_angle_vulkan_device_uuid)
...
#if !defined(EGL_ANGLE_platform_angle_device_context_volatile_cgl)
...
#if !defined(EGL_ANGLE_platform_angle_device_id)
...
#if !defined(EGL_ANGLE_x11_visual)
#define EGL_ANGLE_x11_visual
#define EGL_X11_VISUAL_ID_ANGLE 0x33A3
#endif

#if !defined(EGL_ANGLE_surface_orientation)
...
#if !defined(EGL_ANGLE_experimental_present_path)
...
#if !defined(EGL_ANGLE_stream_producer_d3d_texture)
...
#if !defined(EGL_ANGLE_program_cache_control)
...
#if !defined(EGL_ANGLE_iosurface_client_buffer)
...
#if !defined(ANGLE_metal_texture_client_buffer)
...
#if !defined(EGL_ANGLE_create_context_extensions_enabled)
#define EGL_ANGLE_create_context_extensions_enabled 1
#define EGL_EXTENSIONS_ENABLED_ANGLE 0x345F
#endif

#if !defined(EGL_CHROMIUM_sync_control)
...
#if !defined(EGL_ANGLE_power_preference)
...
#if !defined(EGL_ANGLE_wait_until_work_scheduled)
...
#if !defined(EGL_ANGLE_feature_control)
...
#if !defined(EGL_ANGLE_vulkan_image)
...
#if !defined(EGL_ANGLE_metal_shared_event_sync)
...
#if !defined(EGL_ANGLE_create_context_passthrough_shaders)
