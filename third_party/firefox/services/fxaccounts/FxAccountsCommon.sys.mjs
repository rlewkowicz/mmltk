...
export let OAUTH_TOKEN_FOR_SYNC_LIFETIME_SECONDS = 3600 * 6; 
export let ATTACHED_CLIENTS_CACHE_DURATION = 4 * 60 * 60 * 1000; 

export let POLL_SESSION = 1000 * 60 * 20; 
...
export let ON_PROFILE_UPDATED_NOTIFICATION = "fxaccounts:profile_updated"; 
...
export let ON_PROFILE_CHANGE_NOTIFICATION = "fxaccounts:profilechange"; 
