...
#if !defined(VPX_VPX_DSP_X86_INV_TXFM_SSSE3_H_)
...
static INLINE void idct8x8_12_add_kernel_ssse3(__m128i *const io ) {
  ...
  step1[4] = _mm_mulhrs_epi16(tmp[1], cp_28d_4d);    
  step1[5] = _mm_mulhrs_epi16(tmp[3], cp_n20d_12d);  

  step2[0] = _mm_mulhrs_epi16(tmp[0], cospi_16_64d);  
  step2[2] = _mm_mulhrs_epi16(tmp[2], cp_8d_24d);     
  step2[4] = _mm_add_epi16(step1[4], step1[5]);       
  step2[5] = _mm_sub_epi16(step1[4], step1[5]);       
  step2[6] = _mm_unpackhi_epi64(step2[5], step2[5]);  

  tmp[0] = _mm_unpacklo_epi16(step2[6], step2[5]);
  step1[5] = idct_calc_wraplow_sse2(cp_16_n16, cp_16_16, tmp[0]);  
  ...
  step2[0] = _mm_mulhrs_epi16(io[0], cospi_16_64d);  
