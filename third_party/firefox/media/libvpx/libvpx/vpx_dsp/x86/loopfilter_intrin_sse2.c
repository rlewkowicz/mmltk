...
#define FILTER_HEV_MASK                                                       \
  do {                                                                        \
    ...
    hev = _mm_packs_epi16(hev, hev);                                          \
        ...
        \
    abs_p0q0 =                                                                \
        _mm_adds_epu8(abs_p1q1p0q0, abs_p1q1p0q0);      \
    abs_p1q1 =                                                                \
        _mm_unpackhi_epi8(abs_p1q1p0q0, abs_p1q1p0q0);      \
...
#define FILTER4                                                             \
  do {                                                                      \
    ...
    qs1qs0 = _mm_xor_si128(qs1qs0, t80);                        \
    ps1ps0 = _mm_xor_si128(ps1ps0, t80);                        \
  } while (0)
