...
struct WebSocketHandshake {
    ...
    struct Sha1Loop1 {
        ...
        static inline void f(uint32_t* a, uint32_t* b) {
            a[i % 5] += ((a[(3 + i) % 5] & (a[(2 + i) % 5] ^ a[(1 + i) % 5])) ^ a[(1 + i) % 5]) + b[i] + 0x5a827999 +
                        rol(a[(4 + i) % 5], 5);
    ...
    struct Sha1Loop2 {
        ...
        static inline void f(uint32_t* a, uint32_t* b) {
            b[i] = blk(b, i);
            a[(1 + i) % 5] += ((a[(4 + i) % 5] & (a[(3 + i) % 5] ^ a[(2 + i) % 5])) ^ a[(2 + i) % 5]) + b[i] +
    ...
    struct Sha1Loop3 {
        ...
        static inline void f(uint32_t* a, uint32_t* b) {
            ...
            a[i % 5] += (a[(3 + i) % 5] ^ a[(2 + i) % 5] ^ a[(1 + i) % 5]) + b[(i + 4) % 16] + 0x6ed9eba1 +
                        rol(a[(4 + i) % 5], 5);
            a[(3 + i) % 5] = rol(a[(3 + i) % 5], 30);
        }
    };
    ...
    struct Sha1Loop5 {
        ...
        static inline void f(uint32_t* a, uint32_t* b) {
            ...
            a[i % 5] += (a[(3 + i) % 5] ^ a[(2 + i) % 5] ^ a[(1 + i) % 5]) + b[(i + 12) % 16] + 0xca62c1d6 +
                        rol(a[(4 + i) % 5], 5);
            a[(3 + i) % 5] = rol(a[(3 + i) % 5], 30);
        }
    };
