...
#define CATCH_INTERNAL_SUPPRESS_SIGN_COMPARE_WARNINGS _Pragma("GCC diagnostic ignored \"-Wsign-compare\"")

#define CATCH_INTERNAL_SUPPRESS_NON_VIRTUAL_DTOR_WARNINGS _Pragma("GCC diagnostic ignored \"-Wnon-virtual-dtor\"")
...
#define CATCH_INTERNAL_SUPPRESS_ZERO_VARIADIC_WARNINGS _Pragma("clang diagnostic ignored \"-Wc++20-extensions\"")
#else
#define CATCH_INTERNAL_SUPPRESS_ZERO_VARIADIC_WARNINGS \
...
#define CATCH_INTERNAL_SUPPRESS_SIGN_COMPARE_WARNINGS _Pragma("clang diagnostic ignored \"-Wsign-compare\"")

#define CATCH_INTERNAL_SUPPRESS_NON_VIRTUAL_DTOR_WARNINGS _Pragma("clang diagnostic ignored \"-Wnon-virtual-dtor\"")
...
#define CATCH_INTERNAL_SUPPRESS_GLOBALS_WARNINGS __pragma(warning(disable : 26426))
...
#endif
#if !defined(CATCH_INTERNAL_SUPPRESS_SIGN_COMPARE_WARNINGS)
#define CATCH_INTERNAL_SUPPRESS_SIGN_COMPARE_WARNINGS
#endif
#if !defined(CATCH_INTERNAL_SUPPRESS_NON_VIRTUAL_DTOR_WARNINGS)
#define CATCH_INTERNAL_SUPPRESS_NON_VIRTUAL_DTOR_WARNINGS
#endif
