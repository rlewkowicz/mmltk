...
namespace Catch {
    ...
    namespace {
        ...
        std::size_t maxDescriptionNameLength(
            std::vector<Description> const& descriptions,
        ...
        void printDescriptionEntries(std::ostream& out,
                                     std::vector<Description> const& descriptions,
                                     NameGetter nameGetter,
    ...
    namespace Detail {
        ...
        SharedAssertionPrinter::SharedAssertionPrinter(std::ostream& stream_,
                                                       AssertionStats const& stats,
                                                       bool printInfoMessages_,
        ...
        void SharedAssertionPrinter::printExpressionWas() {
            if ( result.hasExpression() ) {
                stream << ';'
                       << colourImpl->guardColour( dimColour )
                       << " expression was:";
        ...
        void SharedAssertionPrinter::printRemainingMessages( Colour::Code colour ) {
            ...
            stream << colourImpl->guardColour( colour ) << " with "
                   << pluralise( messageCount, "message"_sr ) << ':';
    ...
    defaultListReporters( std::ostream& out,
        ...
        if ( verbosity == Verbosity::Quiet ) {
            const auto maxNameLen =
                maxDescriptionNameLength(descriptions, [](ReporterDescription const& desc) {
                    return desc.name;
                });
            for ( auto const& desc : descriptions ) {
            ...
            printDescriptionEntries(
                out,
                descriptions,
                []( ReporterDescription const& desc ) -> std::string const& { return desc.name; },
    ...
    void defaultListListeners( std::ostream& out,
        ...
        printDescriptionEntries(
            out,
            descriptions,
            []( ListenerDescription const& desc ) { return desc.name; },
