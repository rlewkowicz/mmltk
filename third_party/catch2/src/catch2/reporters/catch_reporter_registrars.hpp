...
#define CATCH_REGISTER_REPORTER(name, reporterType)                                                             \
    ...
    namespace {                                                                                                 \
    const Catch::ReporterRegistrar<reporterType> INTERNAL_CATCH_UNIQUE_NAME(catch_internal_RegistrarFor)(name); \
    }                                                                                                           \
...
#define CATCH_REGISTER_LISTENER(listenerType)                                                             \
    ...
    CATCH_INTERNAL_SUPPRESS_GLOBALS_WARNINGS                                                              \
    namespace {                                                                                           \
    const Catch::ListenerRegistrar<listenerType> INTERNAL_CATCH_UNIQUE_NAME(catch_internal_RegistrarFor)( \
