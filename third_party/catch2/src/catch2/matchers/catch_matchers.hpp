...
class MatchAllOf final : public MatcherBase<ArgT> {
   ...
   public:
    ...
    std::string describe() const override {
        return describeMatchers(" and ", m_matchers);
    }
    ...
    friend MatchAllOf operator&&(MatcherBase<ArgT> const& lhs CATCH_ATTR_LIFETIMEBOUND, MatchAllOf&& rhs) {
...
class MatchAnyOf final : public MatcherBase<ArgT> {
   ...
   public:
    ...
    std::string describe() const override {
        return describeMatchers(" or ", m_matchers);
    }
    ...
    friend MatchAnyOf operator||(MatcherBase<ArgT> const& lhs CATCH_ATTR_LIFETIMEBOUND, MatchAnyOf&& rhs) {
        rhs.m_matchers.insert(rhs.m_matchers.begin(), &lhs);
        return CATCH_MOVE(rhs);
    }
};
