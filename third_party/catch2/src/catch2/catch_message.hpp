...
#define INTERNAL_CATCH_CAPTURE(varName, macroName, scopedCapture, ...)                             \
    Catch::Capturer varName(macroName##_catch_sr, CATCH_INTERNAL_LINEINFO, Catch::ResultWas::Info, \
                            #__VA_ARGS__##_catch_sr, scopedCapture);                               \
...
#define CATCH_CAPTURE(...) \
    INTERNAL_CATCH_CAPTURE(INTERNAL_CATCH_UNIQUE_NAME(capturer), "CATCH_CAPTURE", true, __VA_ARGS__)
#define CATCH_UNSCOPED_CAPTURE(...) \
    INTERNAL_CATCH_CAPTURE(INTERNAL_CATCH_UNIQUE_NAME(capturer), "CATCH_UNSCOPED_CAPTURE", false, __VA_ARGS__)
...
#define UNSCOPED_CAPTURE(...) \
    INTERNAL_CATCH_CAPTURE(INTERNAL_CATCH_UNIQUE_NAME(capturer), "UNSCOPED_CAPTURE", false, __VA_ARGS__)
