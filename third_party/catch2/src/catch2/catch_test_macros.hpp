...
#define CATCH_REQUIRE(...) INTERNAL_CATCH_REQUIRE("CATCH_REQUIRE", __VA_ARGS__)
#define CATCH_REQUIRE_FALSE(...) INTERNAL_CATCH_REQUIRE_FALSE("CATCH_REQUIRE_FALSE", __VA_ARGS__)
...
#define CATCH_SKIP(...)                                                                                    \
    do {                                                                                                   \
        INTERNAL_CATCH_MSG("CATCH_SKIP", Catch::ResultWas::ExplicitSkip, Catch::ResultDisposition::Normal, \
                           __VA_ARGS__);                                                                   \
        Catch::Detail::Unreachable();                                                                      \
    } while (false)
...
#define REQUIRE(...) INTERNAL_CATCH_REQUIRE("REQUIRE", __VA_ARGS__)
#define REQUIRE_FALSE(...) INTERNAL_CATCH_REQUIRE_FALSE("REQUIRE_FALSE", __VA_ARGS__)
