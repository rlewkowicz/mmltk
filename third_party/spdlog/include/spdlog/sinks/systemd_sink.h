...
protected:
    ...
    void sink_it_(const details::log_msg &msg) override {
        ...
        const string_view_t payload = details::format_log_msg_payload(
            enable_formatting_, *base_sink<Mutex>::formatter_, msg, formatted);
        ...
        if (msg.source.empty()) {
            ...
            err = (sd_journal_send)("MESSAGE=%.*s", length, payload.data(),
