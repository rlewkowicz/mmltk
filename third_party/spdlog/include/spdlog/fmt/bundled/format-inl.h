...
struct cache_compute_mul_result {
    Carrier result;
    bool is_integer;
};
struct cache_compute_mul_parity_result {
    bool parity;
    bool is_integer;
};
...
struct cache_accessor<float> {
    ...
    using compute_mul_result = cache_compute_mul_result<carrier_uint>;
    using compute_mul_parity_result = cache_compute_mul_parity_result;
...
extern "C" __declspec(dllimport) int __stdcall WriteConsoleW(void*, const void*, dword, dword*, void*);
