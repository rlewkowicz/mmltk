...
use iced_core::{Background, Color, Shadow, Theme, Vector};

const DROP_SHADOW_ALPHA: f32 = 0.18;
const DROP_SHADOW_SIZE: f32 = 2.0;
...
impl Default for Style {
    fn default() -> Self {
        Self {
            ...
            shadow: Shadow {
                color: Color::BLACK.scale_alpha(DROP_SHADOW_ALPHA),
                offset: Vector::new(0.0, DROP_SHADOW_SIZE),
                blur_radius: DROP_SHADOW_SIZE,
            },
