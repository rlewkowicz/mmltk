...
inline void launch_sample_packed_masks_cuda(
    const int64_t* packed_bits, const int64_t* mask_indices, const float* coords, const float* inverse_transforms,
    const int64_t* occluder_mask_indices, const float* occluder_inverse_transforms, float* output,
    const int64_t mask_count, const int64_t coord_batches, const int64_t words_per_mask, const int64_t height,
    const int64_t width, const int64_t point_count, const int64_t transform_stride, cudaStream_t stream) {
    launch_sample_packed_masks_cuda(training_mask_ops_launch::PackedMaskSampleLaunch{
        packed_bits,
        mask_indices,
        coords,
        inverse_transforms,
        occluder_mask_indices,
        occluder_inverse_transforms,
        output,
        mask_count,
        coord_batches,
        words_per_mask,
