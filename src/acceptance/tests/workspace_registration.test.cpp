...
TEST_CASE("test_workspace_slot_release_registration_handles_window_death_and_system_teardown", "[core][vendored]") {
 test_workspace_slot_release_registration_handles_window_death_and_system_teardown();
}
