...
inline constexpr std::array<BrowserNativeFileDialogContractSpec, 30U> kBrowserNativeFileDialogs{{
    ...
    {"train.dataset.source_dir",
     ...
     "sourceDir",
     "Choose raw dataset directory",
     "",
     {"", "", "", "", ""},
     0U,
     BrowserFileDialogBinding::TrainDatasetSourceDir},
    {"train.dataset.compiled_directory",
     Workflow::Train,
     FileDialogMode::OpenFolder,
     "compiledDirectory",
     "Choose compiled dataset directory",
     "",
     {"", "", "", "", ""},
     0U,
     BrowserFileDialogBinding::TrainCompiledDatasetDir},
    {"train.model.weights",
     Workflow::Train,
     FileDialogMode::OpenFile,
     "weightsPath",
    ...
    {"validate.model.weights",
     ...
     FileDialogMode::OpenFile,
     "weightsPath",
     "Choose validation weights",
     "Weights",
     {"*.pt", "*.pth", "*.ckpt", "*.safetensors", ""},
     4U,
     BrowserFileDialogBinding::ValidateWeights},
    {"validate.model.onnx",
     Workflow::Validate,
     FileDialogMode::OpenFile,
     "onnxPath",
