...
[[nodiscard]] AnnotationSidebarSelectedSkeletonViewModel
make_selected_skeleton_sidebar_view_model(
    const AnnotationSession& session,
    std::size_t object_index,
...
[[nodiscard]] bool update_selected_skeleton_object_metadata(
...
[[nodiscard]] AnnotationToolMutation handle_skeleton_canvas_click(
    const AnnotationToolContext& context,
    const AnnotationToolCanvasClickEvent& event);
[[nodiscard]] AnnotationToolMutation handle_skeleton_action(
    const AnnotationToolContext& context,
    const AnnotationToolActionEvent& event);

bool set_selected_skeleton_active_joint(AnnotationDocument& document,
                                        AnnotationSession& session,
