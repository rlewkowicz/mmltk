...
public:
    [[nodiscard]] AnnotationToolKind kind() const noexcept override { return AnnotationToolKind::Skeleton; }
    ...
    [[nodiscard]] std::optional<AnnotationObject> make_object(
        ...
        return make_skeleton_annotation_object(request.object_count,
