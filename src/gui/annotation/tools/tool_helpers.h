...
[[nodiscard]] AnnotationEditTransactionKind grouped_edit_kind_for_tool(
    AnnotationToolKind tool) noexcept;
AnnotationPoint capture_point_from_event(const AnnotationToolCanvasClickEvent& event);
std::optional<std::size_t> clamp_active_index(std::size_t size,
