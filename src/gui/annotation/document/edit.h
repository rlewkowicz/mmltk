...
AnnotationObject make_point_annotation_object(std::size_t object_count,
                                              std::size_t category_index,
                                              const AnnotationPoint& point);
AnnotationObject make_spline_annotation_object(std::size_t object_count,
                                               std::size_t category_index);
AnnotationObject make_skeleton_annotation_object(std::size_t object_count,
                                                 std::size_t category_index,
