...
inline constexpr std::array<BrowserNumericEnumSchemaSpec, 3U> kBrowserSettingsNumericEnumSchemas{{
    {"TrainInputMode", "train_input_mode", {0, 1, 0, 0}, 2U},
    {"ModelInputMode", "model_input", {0, 1, 2, 3}, 4U},
    {"CompileMode", "compile_mode", {0, 1, 2, 0}, 3U},
}};

inline constexpr std::array<BrowserSettingsPatchValueTypeSpec, 142U> kBrowserSettingsPatchValueTypes{{
    ...
    {"ui.property_label_width", "number"},
    ...
    {"workflows.predict.predict.model_input", "model_input"},
    ...
    {"workflows.annotate.annotate.model_input", "model_input"},
...
struct BrowserSettingsContract<mmltk::gui::UiSettingsState> {
    [[nodiscard]] static constexpr auto fields() {
        ...
        return std::tuple{
            ...
            api::field<&State::property_label_width>("property_label_width"),
    ...
    [[nodiscard]] static constexpr auto fields() {
        ...
        return std::tuple_cat(std::tuple{
            ...
            api::field<&State::compile_mode>("compile_mode"),
                              ...
                              train_execution_fields<State>(), std::tuple{
            api::field<&State::output_dir>("output_dir"),
            api::field<&State::resume_path>("resume_path"),
            api::field<&State::input_mode>("input_mode"),
...
struct BrowserSettingsContract<mmltk::gui::AnnotateViewState> {
    [[nodiscard]] static constexpr auto fields() {
        ...
        return std::tuple{
            api::field<&State::source>("source"),         api::field<&State::weights_path>("weights_path"),
            api::field<&State::onnx_path>("onnx_path"),   api::field<&State::tensorrt_path>("tensorrt_path"),
            api::field<&State::output_dir>("output_dir"), api::field<&State::split>("split"),
            api::field<&State::backend>("backend"),       api::field<&State::model_input>("model_input"),
            api::field<&State::device_id>("device_id"),   api::field<&State::max_dets_per_image>("max_dets_per_image"),
            api::field<&State::threshold>("threshold"),   api::field<&State::allow_fp16>("allow_fp16"),
            api::field<&State::full_frame>("full_frame"), api::field<&State::compile_mode>("compile_mode"),
        };
    }
};
...
struct BrowserSettingsContract<mmltk::gui::ExportViewState> {
    [[nodiscard]] static constexpr auto fields() {
        ...
        return std::tuple{
            api::field<&State::weights_path>("weights_path"),     api::field<&State::onnx_path>("onnx_path"),
            api::field<&State::output_path>("output_path"),       api::field<&State::device_id>("device_id"),
            api::field<&State::opset_version>("opset_version"),   api::field<&State::allow_fp16>("allow_fp16"),
            api::field<&State::build_tensorrt>("build_tensorrt"), api::field<&State::simplify>("simplify"),
        };
    }
};
