...
struct WorkflowSettingsState {
    ...
    [[= mmltk::controller::contracts::reflection::feature_scope(
        mmltk::controller::contracts::FeatureId::Validate)]] ValidateViewState validate;
    ...
    // projection.
    [[= mmltk::controller::contracts::reflection::feature_scope(
        mmltk::controller::contracts::FeatureId::Annotate)]] AnnotateViewState annotate;
    [[= mmltk::controller::contracts::reflection::feature_scope(
        mmltk::controller::contracts::FeatureId::Export)]] ExportViewState export_state;
    [[= mmltk::controller::contracts::reflection::feature_scope(
        mmltk::controller::contracts::FeatureId::Explore)]] ExploreViewState explore;
...
struct GuiSettingsState {
    [[= mmltk::frameworks::serialization::DefaultValue<
        mmltk::controller::contracts::FeatureId::Train>{}]] mmltk::controller::contracts::FeatureId current_view =
