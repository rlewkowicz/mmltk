...
class TrainRunStore final {
   public:
    [[nodiscard]] mmltk::backend::models::rfdetr::TrainingRun Open(const std::filesystem::path&);
    [[nodiscard]] mmltk::backend::models::rfdetr::TrainingHistoryPage Read(
        const mmltk::backend::models::rfdetr::TrainingHistoryQuery&);
    ...
    [[nodiscard]] static std::filesystem::path ResolveOutput(const std::filesystem::path&, const std::optional<mmltk::backend::models::rfdetr::TrainingCheckpoint>& resume = {});
   private:
