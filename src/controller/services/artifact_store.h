...
[[nodiscard]] mmltk::controller::contracts::ArtifactProgress project_artifact_progress(
    const mmltk::backend::data::BenchmarkCompileProgress& value);
...
class ArtifactStore final {
   public:
    ...
    [[nodiscard]] mmltk::controller::contracts::ArtifactInspection inspect(
        const std::array<std::filesystem::path, mmltk::controller::contracts::kArtifactSplitCapacity>& paths, std::string_view preset,
