...
class FirefoxProcessOwner final {
   public:
    FirefoxProcessOwner(std::filesystem::path workspace_import_socket, FirefoxProcessConfig config,
                        FirefoxProcessObservationTarget observations, RuntimeDiagnosticTarget diagnostics = {}) noexcept;
