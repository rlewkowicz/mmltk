...
[[nodiscard]] constexpr bool valid_vast_mutation(const mmltk::controller::contracts::ProviderMutation mutation) noexcept {
    switch (mutation) {
        ...
        case mmltk::controller::contracts::ProviderMutation::Stop:
            return true;
    }
    return false;
}
...
class VastClient final {
   public:
    ...
    [[nodiscard]] VastOffers query(const mmltk::controller::contracts::ProviderPreferences& preferences,
    ...
    [[nodiscard]] VastCreateInstanceResult create(int offer_id, const mmltk::controller::contracts::ProviderPreferences& preferences,
                                                  std::string_view launch_token, VastEffectAttempt& attempt,
                                                  const VastCancellationToken& cancellation) const;
