...
struct NativePresentationWriterTestAccess final {
    [[nodiscard]] static std::unique_ptr<PresentationNativeWriter> Create(mmltk::frameworks::gpu::DeviceContext,
                                                                          PresentationNativeConfiguration,
                                                                          std::shared_ptr<mmltk::frameworks::gpu::ImageWorkspace>,
