...
[[nodiscard]] cudaError_t copy_live_receiver_frame(mmltk::frameworks::gpu::ImagePlaneView target, std::uintptr_t source,
                                                   std::size_t source_pitch, std::uintptr_t ready_event, std::uintptr_t stream,
                                                   const LiveReceiverCopyOperations&) noexcept;
