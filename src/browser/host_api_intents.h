...
struct PredictStartIntent {
    ...
    [[nodiscard]] static constexpr auto api_fields() {
        return std::tuple{
            api::field<&PredictStartIntent::selected_preset>("selected_preset"),
...
struct AnnotateWorkspacePointerIntent {
    ...
    [[nodiscard]] static constexpr auto api_fields() {
        return std::tuple{
            ...
            api::field<&AnnotateWorkspacePointerIntent::brush_radius>("brush_radius", api::required,
                                                                      api::minimum(1)),
...
struct WorkspaceRendererEventIntent {
    ...
    [[nodiscard]] static constexpr auto api_fields() {
        return std::tuple{
            api::field<&WorkspaceRendererEventIntent::surface_id>("surface_id", api::required),
            api::field<&WorkspaceRendererEventIntent::revision>("revision", api::required),
            api::field<&WorkspaceRendererEventIntent::operation>("operation", api::required),
            api::field<&WorkspaceRendererEventIntent::result_code>("result_code"),
            api::field<&WorkspaceRendererEventIntent::result_detail>("result_detail"),
        };
    }

    [[nodiscard]] static constexpr auto api_intent() {
        return api::intent("workspace.drawn", api::workflow_set(Workflow::Predict, Workflow::Annotate, Workflow::Live),
                           "WorkspaceRendererEventIntent");
    }

    [[nodiscard]] static constexpr auto api_intents() {
        return std::tuple{
            api::intent("workspace.drawn", api::workflow_set(Workflow::Predict, Workflow::Annotate, Workflow::Live),
                        "WorkspaceRendererEventIntent"),
            api::intent("workspace.imported", api::workflow_set(Workflow::Predict, Workflow::Annotate, Workflow::Live),
                        "WorkspaceRendererEventIntent"),
            api::intent("workspace.import_failed",
                        api::workflow_set(Workflow::Predict, Workflow::Annotate, Workflow::Live),
                        "WorkspaceRendererEventIntent"),
            api::intent("workspace.acquire_failed",
                        api::workflow_set(Workflow::Predict, Workflow::Annotate, Workflow::Live),
                        "WorkspaceRendererEventIntent"),
            api::intent("workspace.release_complete",
                        api::workflow_set(Workflow::Predict, Workflow::Annotate, Workflow::Live),
                        "WorkspaceRendererEventIntent"),
            api::intent("workspace.release_rejected",
                        api::workflow_set(Workflow::Predict, Workflow::Annotate, Workflow::Live),
                        "WorkspaceRendererEventIntent"),
        };
    }
...
struct FileDialogRequestIntent {
    ...
    [[nodiscard]] static constexpr auto api_fields() {
        return std::tuple{
            ...
            api::field<&FileDialogRequestIntent::default_path>("default_path"),
...
using BrowserIntentPayloadTypes =
    api::type_list<TrainStartIntent, TrainStopIntent, TrainRemoteQueryIntent, TrainLocalGpuRefreshIntent,
                   ...
                   LivePreviewControlIntent, SettingsUpdateIntent, WorkspaceRendererEventIntent, WorkspaceBoundsIntent,
                   CropCommitIntent, FileDialogRequestIntent, ViewportCommitIntent>;

using BrowserBoundarySchemaTypes = api::type_list<
    Workflow, SourceKind, BrowserHostBackend, BrowserRuntimeCapabilityStatus, BrowserBridgePhase, FileDialogMode,
    AnnotateWorkspacePhase, AnnotateHandleRole, AnnotateBoxDragKind, AnnotateSetupAction, CaptureRegion, JobLogEntry,
    JobState, SourceMetadata, AnnotationDocumentState, WorkspaceSurfaceInfo, BrowserRuntimeCapabilities, StateSnapshot,
    IntentMessage, TrainStartIntent, TrainStopIntent, TrainRemoteQueryIntent, TrainLocalGpuRefreshIntent,
    TrainRemoteOfferArmIntent, TrainRemoteOfferClearIntent, TrainRemoteStartIntent, TrainRemoteStopIntent,
    PredictStartIntentPayload, PredictStartIntent, EmptyIntentPayload, PredictStopIntent, ValidateStartIntent,
    ExportStartIntent, AnnotateSaveIntent, AnnotateLiveStartIntentPayload, AnnotateLiveStopIntentPayload,
    AnnotateSetupIntent, AnnotateHoldSaveIntent, AnnotateBrushRadiusIntent, AnnotateSidebarIntent,
    AnnotateWorkspaceHandleRef, AnnotateWorkspaceClickIntent, AnnotateWorkspaceBoxDragIntent,
    AnnotateWorkspaceHandleDragIntent, AnnotateWorkspaceBrushIntent, AnnotateWorkspacePointerIntent,
    AnnotateWorkspaceFillIntent, AnnotateWorkspaceColorSampleIntent, ToolSelectIntentPayload, ToolSelectIntent,
    LivePreviewControlIntentPayload, LivePreviewControlIntent, WorkspaceRendererEventIntent, WorkspaceSurfaceRect,
    WorkspaceBoundsIntent, SettingsUpdateIntent, CropCommitIntent, FileDialogFilter, FileDialogRequestIntent,
    ViewportCommitIntent>;
