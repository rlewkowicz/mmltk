...
mod tests {
    ...
    fn pointer_sequence_has_one_begin_updates_and_one_end() {
        ...
        assert_eq!(end.phase, crate::generated::AnnotationPointerPhase::End);
    ...
    #[test]
    fn local_end_and_cancel_each_close_one_pointer_interaction() {
        let model = model_with_objects();
        let gesture = |kind, pressed| crate::presentation_surface::SurfaceGesture {
            kind,
            sample: crate::presentation_surface::SurfaceSample {
                width: 640,
                height: 480,
        ...
        for terminal_kind in [
            ...
            assert_eq!(
                terminal.phase,
                if terminal_kind == crate::presentation_surface::SurfaceGestureKind::End {
                    crate::generated::AnnotationPointerPhase::End
                } else {
                    crate::generated::AnnotationPointerPhase::Cancel
                }
            );
            assert_eq!(terminal.sequence, begin.sequence + 1);
    ...
    fn clearing_pointer_lifecycle_preserves_inspector_drafts() {
        ...
        assert_eq!(inspector.category_draft, "vehicle");
        assert_eq!(inspector.handle_x_draft, "12");
        assert_eq!(inspector.handle_y_draft, "34");
    }
