...
struct ManualMaskMappingAbi {
    ...
    [[nodiscard]] constexpr bool operator==(const ManualMaskMappingAbi& other) const noexcept {
        return source_width == other.source_width && source_height == other.source_height && source_crop_x == other.source_crop_x &&
               source_crop_y == other.source_crop_y && source_crop_width == other.source_crop_width && source_crop_height == other.source_crop_height &&
               output_width == other.output_width && output_height == other.output_height && view_x == other.view_x && view_y == other.view_y;
    }
};
}  // namespace mmltk::backend::imaging::annotation::detail
