...
struct AnnotationSceneView {
    ...
    [[nodiscard]] const AnnotationObject* object(const std::size_t index) const noexcept {
...
[[nodiscard]] inline AnnotationPoint annotation_capture_point_to_frame_unclipped(const AnnotationFrame& frame,
...
[[nodiscard]] AnnotationProjectedSceneLookup make_annotation_projected_scene_lookup(const AnnotationProjectedScene* projected_scene,
...
AnnotationSaveResult save_annotation_scene(const AnnotationSaveConfig& config, const AnnotationFrame& frame,
                                           AnnotationCategories& categories, const std::vector<AnnotationObject>& objects, bool live_mode,
                                           const AnnotationProjectedScene* projected_scene = nullptr);
