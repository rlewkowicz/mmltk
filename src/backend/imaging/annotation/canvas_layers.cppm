...
RectDragKind rectangle_hover_kind_with_options(const CanvasPointerState& pointer, const CanvasViewport& viewport, const AnnotationBox& box,
                                               bool edge_only_move, float edge_hit_half_width = 6.0f, float corner_hit_size = 18.0f);
AnnotationBox apply_rect_drag(const RectDragState& state, const CanvasPointerState& pointer, const CanvasViewport& viewport, int max_width,
