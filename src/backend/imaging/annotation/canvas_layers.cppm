...
#include <cstddef>
#include <cstdint>
export module mmltk.backend.imaging.annotation.canvas_layers;
...
CanvasViewport make_canvas_viewport(float screen_x, float screen_y, float screen_width, float screen_height, std::uint32_t image_width,
...
AnnotationBox apply_rect_drag(const RectDragState& state, const CanvasPointerState& pointer, const CanvasViewport& viewport, int max_width, int max_height,
                              int min_size);
RectLayerFrameResult update_rect_layers(RectLayerState& state, const RectLayerSpec* layers, std::size_t layer_count, const CanvasViewport& viewport,
