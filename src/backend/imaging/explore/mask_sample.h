...
[[nodiscard]] __host__ __device__ inline bool sample_annotation_mask(const ExploreRenderRlePairAbi* pairs,
 ...
 if (!annotation.mask_present || !pairs || width == 0U || height == 0U || annotation.rle_offset > capacity ||
     annotation.rle_count > capacity - annotation.rle_offset || annotation.rle_count == 0U || x < annotation.mask_bounds[0] || x > annotation.mask_bounds[2] ||
     y < annotation.mask_bounds[1] || y > annotation.mask_bounds[3])
  return false;
