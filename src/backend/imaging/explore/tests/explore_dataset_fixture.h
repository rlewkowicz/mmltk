...
[[nodiscard]] std::filesystem::path compile_explore_fixture(const std::filesystem::path& temporary_root,
                                                            std::string_view fixture_name = "fixture", int num_images = 2,
                                                            ExploreFixtureDimensions dimensions = {},
...
[[nodiscard]] std::filesystem::path corrupt_explore_label_index(const std::filesystem::path& source,
