...
struct AtlasPaddingColor final { std::uint8_t r, g, b, a; };
...
[[nodiscard]] inline ImageContainRect contain_image(std::uint32_t source_width, std::uint32_t source_height,
                                                   std::uint32_t cell_width, std::uint32_t cell_height) noexcept {
