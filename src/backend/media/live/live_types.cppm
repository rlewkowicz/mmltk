...
struct LiveOutputFrame final {
    ...
    [[nodiscard]] bool valid() const noexcept {
        return pixels != 0U && pitch_bytes != 0U && width != 0U && height != 0U && ready_event != 0U;
    }
};
...
class LiveCompositeOutputLease final {
   public:
    ...
    [[nodiscard]] static LiveCompositeOutputLease Create(void* owner, CompleteCallback complete, AbandonCallback abandon,
                                                         LiveOutputFrame view, PhysicalFrameRevision frame_revision) noexcept;
   ...
   private:
    LiveCompositeOutputLease(void* owner, CompleteCallback complete, AbandonCallback abandon, LiveOutputFrame view,
