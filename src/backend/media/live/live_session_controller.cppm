...
struct LiveAnalysisProviderFactory final {
    ...
    std::shared_ptr<mmltk::backend::ml::runtime::AnalysisProvider> (*create)(const void*,
                                                                             mmltk::backend::ml::runtime::BorrowedCommandStream) = nullptr;

    [[nodiscard]] bool valid() const noexcept { return context != nullptr && create != nullptr; }
    [[nodiscard]] std::shared_ptr<mmltk::backend::ml::runtime::AnalysisProvider> operator()(
        mmltk::backend::ml::runtime::BorrowedCommandStream stream) const {
