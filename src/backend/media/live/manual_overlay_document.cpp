...
std::optional<ManualOverlayDeferredMaskProjection> validate_manual_overlay_deferred_mask(const ManualOverlayDeferredMaskMapping& mapping,
    ...
    if (mapping.source_width == 0U || mapping.source_height == 0U || mapping.source_crop_width == 0U || mapping.source_crop_height == 0U ||
        mapping.output_width == 0U || mapping.output_height == 0U || region.width == 0U || region.height == 0U || target_width == 0U || target_height == 0U ||
        runs.empty() || mapping.source_width > kIntMaximum || mapping.source_height > kIntMaximum || mapping.source_crop_width > kIntMaximum ||
        mapping.source_crop_height > kIntMaximum || mapping.output_width > kIntMaximum || mapping.output_height > kIntMaximum || region.width > kIntMaximum ||
