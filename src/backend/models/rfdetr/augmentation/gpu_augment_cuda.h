...
void update_gpu_augmentation_donor_cache(
 const float* source_images, float* donor_images, const std::int64_t* source_ordinals, std::int64_t batch_size, std::int64_t pixels_per_image, cudaStream_t stream);
}  // namespace mmltk::backend::models::rfdetr
