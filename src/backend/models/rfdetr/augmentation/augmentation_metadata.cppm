...
[[nodiscard]] inline AugmentationMappedInstance map_augmentation_instance(const mmltk::backend::data::PackedInstance& instance,
                                                                          int image_width, int image_height,
                                                                          const AugmentationImagePlan* plan,
    ...
    mapped.source_area_pixels =
        augmentation_box_area(mapped.source_box_xyxy) * static_cast<float>(image_width) * static_cast<float>(image_height);
...
void build_augmentation_preview_annotations(std::span<const mmltk::backend::data::PackedInstance> source_instances,
                                            ...
                                            int image_width, int image_height, std::vector<AugmentationPreviewAnnotation>& output,
