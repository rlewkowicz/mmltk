...
void publish_native_checkpoint_archive(mmltk::backend::ml::torch_api::OutputArchive& archive, const std::filesystem::path& destination, const std::filesystem::path& explicit_descriptor = {});
...
void write_state_archive(mmltk::backend::ml::torch_api::OutputArchive& archive, const char* key,
                         const std::vector<NormalizedModelStateEntry>& entries, mmltk::backend::ml::cuda::TensorReadbackBuffers& readback, std::size_t first_slot);
