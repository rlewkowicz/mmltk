...
inline void copy_checkpoint_archive(mmltk::backend::ml::torch_api::InputArchive& source, mmltk::backend::ml::torch_api::OutputArchive& destination,
...
inline mmltk::backend::ml::torch_api::InputArchive checkpoint_input(mmltk::backend::ml::torch_api::OutputArchive& output) {
