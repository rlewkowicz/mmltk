...
inline void write_int(archive_torch::OutputArchive& archive, const char* key, int64_t value) { archive.write(key, archive_torch::IValue(value)); }
inline void write_bool(archive_torch::OutputArchive& archive, const char* key, bool value) { archive.write(key, archive_torch::IValue(value)); }
inline void write_double(archive_torch::OutputArchive& archive, const char* key, double value) { archive.write(key, archive_torch::IValue(value)); }
