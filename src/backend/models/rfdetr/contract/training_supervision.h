...
struct DenoisingSupervisionConfig {
 ...
 [[= mmltk::frameworks::reflection::Minimum<float>{kSupervisionOpenUnitMinimum}]]
  [[= mmltk::frameworks::reflection::Maximum<float>{kSupervisionOpenUnitMaximum}]][[= mmltk::frameworks::reflection::Finite{}]] float center_noise_scale = 0.4F;
 [[= mmltk::frameworks::reflection::Minimum<float>{kSupervisionOpenUnitMinimum}]]
  [[= mmltk::frameworks::reflection::Maximum<float>{kSupervisionOpenUnitMaximum}]][[= mmltk::frameworks::reflection::Finite{}]] float size_noise_scale = 0.4F;
