...
class GpuPerceptualDownscaler final {
 public:
    explicit GpuPerceptualDownscaler(frameworks::gpu::DeviceContext context,
    ...
    void downscale(RgbConstImageView source, RgbMutableImageView destination, cudaStream_t stream,
