...
inline constexpr std::array kBuildEngineOptions{
 reflection::option<rfdetr::BuildEngineRequest, &rfdetr::BuildEngineRequest::class_layout_path>("--class-layout", "Digest-bound class descriptor",
                                                                                                "Model input"),
 ...
 reflection::option<rfdetr::BuildEngineRequest, &rfdetr::BuildEngineRequest::allow_fp16>("--fp16", "Enable FP16 TensorRT kernels", "Execution", {},
                                                                                         "--no-fp16")};
...
inline constexpr std::array kEvaluateOptions{
 ...
 reflection::option<rfdetr::EvaluateRequest, &rfdetr::EvaluateRequest::candidate_count>("--candidate-count",
                                                                                        "Selected candidate count (0: admitted model default)", "Model input"),
...
inline constexpr std::array kPredictOptions{
 reflection::option<PredictCliRequest, reflection::member_path<&PredictCliRequest::request, &rfdetr::PredictRequest::class_layout_path>>(
 ...
 reflection::negative_flag<PredictCliRequest, reflection::member_path<&PredictCliRequest::request, &rfdetr::PredictRequest::h2d_dataloader>>(
 ...
 reflection::option<PredictCliRequest, reflection::member_path<&PredictCliRequest::request, &rfdetr::PredictRequest::onnx_path>>("--onnx", "ONNX model path",
                                                                                                                                 "Model input"),
 ...
 reflection::option<PredictCliRequest, reflection::member_path<&PredictCliRequest::request, &rfdetr::PredictRequest::device_id>>("--device-id",
                                                                                                                                 "CUDA device id", "Execution"),
 ...
 reflection::option<PredictCliRequest, reflection::member_path<&PredictCliRequest::request, &rfdetr::PredictRequest::allow_fp16>>("--fp16", "Enable FP16",
                                                                                                                                  "Execution", {}, "--no-fp16"),
...
inline constexpr std::array kValidateOptions{
 ...
 reflection::option<rfdetr::ValidateRequest, &rfdetr::ValidateRequest::compile_cuda_mask_batch_size>("--compile-cuda-mask-batch-size", "CUDA mask batch size",
                                                                                                     "Dataset"),
 ...
 reflection::option<rfdetr::ValidateRequest, &rfdetr::ValidateRequest::write_report_json>("--write-report-json", "Write validation report", "Output", {},
...
std::expected<void, reflection::ParseError> assign_train_integer_list(TrainCliRequest& state, const std::string_view text, bool,
 ...
 while (start <= text.size()) {
  if (count == ids.size()) {
   return std::unexpected(reflection::ParseError{reflection::ParseErrorCode::InvalidValue, text, "integer list exceeds the selected-device capacity"});
  }
...
void emit_train_integer_list(std::vector<std::string>& arguments, const TrainCliRequest& state, const std::string_view name, std::string_view,
                             reflection::OptionKind, bool) {
...
inline constexpr std::array kTrainOptions{
 reflection::option<TrainCliRequest, reflection::member_path<&TrainCliRequest::request, &rfdetr::TrainRequest::class_layout_path>>(
  "--class-layout", "Digest-bound class descriptor", "Model input"),
 ...
 reflection::custom_option<TrainCliRequest, reflection::member_path<&TrainCliRequest::request, &rfdetr::TrainRequest::numa_nodes>,
                           &assign_train_integer_list<&rfdetr::TrainRequest::numa_nodes, false>, &emit_train_integer_list<&rfdetr::TrainRequest::numa_nodes>>(
 ...
 reflection::option<TrainCliRequest, reflection::member_path<&TrainCliRequest::request, &rfdetr::TrainRequest::output_dir>>("--output-dir", "Output directory",
                                                                                                                            "Checkpoint"),
 reflection::option<TrainCliRequest, reflection::member_path<&TrainCliRequest::request, &rfdetr::TrainRequest::weights_path>>("--weights", "Source checkpoint",
                                                                                                                              "Checkpoint"),
 ...
 reflection::option<TrainCliRequest, reflection::member_path<&TrainCliRequest::request, &rfdetr::TrainRequest::preset_name>>("--preset", "Declared preset",
                                                                                                                             "Checkpoint"),
 ...
 reflection::option<TrainCliRequest, reflection::member_path<&TrainCliRequest::request, &rfdetr::TrainRequest::epochs>>("--epochs", "Epoch count",
                                                                                                                        "Optimization"),
 ...
 reflection::option<TrainCliRequest, reflection::member_path<&TrainCliRequest::request, &rfdetr::TrainRequest::optimizer>>("--optimizer", "adamw or muon",
                                                                                                                           "Optimization"),
 reflection::option<TrainCliRequest, reflection::member_path<&TrainCliRequest::request, &rfdetr::TrainRequest::lr>>("--lr", "Decoder learning rate",
                                                                                                                    "Optimization"),
 ...
 reflection::option<TrainCliRequest, reflection::member_path<&TrainCliRequest::request, &rfdetr::TrainRequest::weight_decay>>("--weight-decay", "Weight decay",
                                                                                                                              "Optimization"),
 reflection::option<TrainCliRequest, reflection::member_path<&TrainCliRequest::request, &rfdetr::TrainRequest::lr_drop>>("--lr-drop", "Step drop epoch",
                                                                                                                         "Optimization"),
 reflection::option<TrainCliRequest, reflection::member_path<&TrainCliRequest::request, &rfdetr::TrainRequest::lr_scheduler>>("--lr-scheduler",
                                                                                                                              "step or cosine", "Optimization"),
 ...
 reflection::option<TrainCliRequest, reflection::member_path<&TrainCliRequest::request, &rfdetr::TrainRequest::use_ema>>("--use-ema", "Maintain EMA",
                                                                                                                         "Optimization", {}, "--no-ema"),
 ...
 reflection::option<TrainCliRequest, reflection::member_path<&TrainCliRequest::request, &rfdetr::TrainRequest::ema_decay>>("--ema-decay", "EMA decay",
                                                                                                                           "Optimization"),
 reflection::option<TrainCliRequest, reflection::member_path<&TrainCliRequest::request, &rfdetr::TrainRequest::ema_tau>>("--ema-tau", "EMA tau",
                                                                                                                         "Optimization"),
 reflection::option<TrainCliRequest, reflection::member_path<&TrainCliRequest::request, &rfdetr::TrainRequest::eval_max_dets>>("--eval-max-dets",
                                                                                                                               "Detection cap", "Optimization"),
 reflection::option<TrainCliRequest, reflection::member_path<&TrainCliRequest::request, &rfdetr::TrainRequest::training_supervision,
                                                             &rfdetr::TrainingSupervisionConfig::assignment>>("--assignment", "hungarian or match-free",
                                                                                                              "Supervision"),
 reflection::option<TrainCliRequest, reflection::member_path<&TrainCliRequest::request, &rfdetr::TrainRequest::training_supervision,
 ...
 reflection::option<TrainCliRequest,
                    reflection::member_path<&TrainCliRequest::request, &rfdetr::TrainRequest::training_supervision,
                                            &rfdetr::TrainingSupervisionConfig::match_free, &rfdetr::MatchFreeSupervisionConfig::correspondence_weight>>(
  "--match-free-correspondence-weight", "Correspondence objective weight", "Supervision"),
 reflection::option<TrainCliRequest,
                    reflection::member_path<&TrainCliRequest::request, &rfdetr::TrainRequest::training_supervision,
                                            &rfdetr::TrainingSupervisionConfig::match_free, &rfdetr::MatchFreeSupervisionConfig::query_weight>>(
  "--match-free-query-weight", "Query objective weight", "Supervision"),
 reflection::option<TrainCliRequest, reflection::member_path<&TrainCliRequest::request, &rfdetr::TrainRequest::training_supervision,
                                                             &rfdetr::TrainingSupervisionConfig::denoising, &rfdetr::DenoisingSupervisionConfig::enabled>>(
 ...
 reflection::option<TrainCliRequest,
                    reflection::member_path<&TrainCliRequest::request, &rfdetr::TrainRequest::training_supervision,
                                            &rfdetr::TrainingSupervisionConfig::denoising, &rfdetr::DenoisingSupervisionConfig::label_noise_ratio>>(
  "--dn-label-noise-ratio", "Denoising label flip probability", "Supervision"),
 reflection::option<TrainCliRequest,
                    reflection::member_path<&TrainCliRequest::request, &rfdetr::TrainRequest::training_supervision,
                                            &rfdetr::TrainingSupervisionConfig::denoising, &rfdetr::DenoisingSupervisionConfig::center_noise_scale>>(
  "--dn-center-noise-scale", "Denoising center noise scale", "Supervision"),
 reflection::option<TrainCliRequest,
                    reflection::member_path<&TrainCliRequest::request, &rfdetr::TrainRequest::training_supervision,
                                            &rfdetr::TrainingSupervisionConfig::denoising, &rfdetr::DenoisingSupervisionConfig::size_noise_scale>>(
  "--dn-size-noise-scale", "Denoising size noise scale", "Supervision"),
 reflection::option<TrainCliRequest,
                    reflection::member_path<&TrainCliRequest::request, &rfdetr::TrainRequest::gpu_augmentation, &rfdetr::GpuAugmentationConfig::enabled>>(
 ...
 reflection::option<TrainCliRequest, reflection::member_path<&TrainCliRequest::request, &rfdetr::TrainRequest::device_id>>("--device-id", "Single CUDA device",
                                                                                                                           "Execution"),
 reflection::custom_option<TrainCliRequest, reflection::member_path<&TrainCliRequest::request, &rfdetr::TrainRequest::device_ids>,
                           &assign_train_integer_list<&rfdetr::TrainRequest::device_ids, true>, &emit_train_integer_list<&rfdetr::TrainRequest::device_ids>>(
  "--device-ids", "Comma-separated CUDA device ids", "Execution"),
 reflection::option<TrainCliRequest, reflection::member_path<&TrainCliRequest::request, &rfdetr::TrainRequest::workers>>("--workers", "Dataset worker count",
                                                                                                                         "Execution"),
 reflection::option<TrainCliRequest, reflection::member_path<&TrainCliRequest::request, &rfdetr::TrainRequest::lanes>>("--lanes", "Parallel backend lanes",
                                                                                                                       "Execution"),
 reflection::option<TrainCliRequest, reflection::member_path<&TrainCliRequest::request, &rfdetr::TrainRequest::cpu_affinity>>("--cpu-affinity",
                                                                                                                              "Linux CPU list", "Execution"),
 ...
 reflection::option<TrainCliRequest, reflection::member_path<&TrainCliRequest::request, &rfdetr::TrainRequest::print_freq>>("--print-freq", "Logging frequency",
                                                                                                                            "Execution"),
 ...
 reflection::option<TrainCliRequest, reflection::member_path<&TrainCliRequest::request, &rfdetr::TrainRequest::amp>>("--amp", "Automatic mixed precision",
                                                                                                                     "Execution", {}, "--no-amp"),
 reflection::option<TrainCliRequest, reflection::member_path<&TrainCliRequest::request, &rfdetr::TrainRequest::progress_bar>>("--progress", "Render progress",
 ...
 reflection::option<TrainCliRequest, reflection::member_path<&TrainCliRequest::request, &rfdetr::TrainRequest::distributed_rank>>("--dist-rank", "Worker rank",
...
inline constexpr std::array kBuildEngineUnexposed{
 reflection::unexposed<rfdetr::BuildEngineRequest, &rfdetr::BuildEngineRequest::weights_path>("build-engine accepts the selected ONNX artifact kind"),
...
int dispatch_command(const rfdetr::RfdetrCommandDescriptor& descriptor, const std::span<const std::string_view> arguments, const bool help_requested,
                     const logging::CliOverrides& logging_options) {
  ...
  case rfdetr::RfdetrCommand::NormalizeWeights: {
   ...
   if (logging::enabled(spdlog::level::info)) {
    logging::info("rfdetr.cli", [&](auto& current) {
     current.info("rfdetr.normalize-weights: wrote {} tensors for preset={} to {}", checkpoint.tensor_count(), checkpoint.metadata.preset_name,
                  request.output_path.string());
    });
   } else {
    std::printf("rfdetr.normalize-weights: wrote %zu tensors for preset=%s to %s\n", checkpoint.tensor_count(), checkpoint.metadata.preset_name.c_str(),
