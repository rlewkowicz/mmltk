    ...
    return lhs.size() == rhs.size() &&
           std::equal(lhs.begin(),
                      ...
                      [&equal](const T& left, const T& right) {
                          return std::forward<EqualFn>(equal)(left, right);
                      });
}
...
inline bool manual_box_equals(const live::ManualOverlayBox& lhs,
                              const live::ManualOverlayBox& rhs) {
...
inline bool manual_mask_region_equals(const live::ManualOverlayMaskRegion& lhs,
    ...
    return lhs.capture_x == rhs.capture_x &&
           lhs.capture_y == rhs.capture_y &&
           lhs.width == rhs.width &&
           lhs.height == rhs.height;
}

inline bool manual_point_equals(const live::ManualOverlayPoint& lhs,
                                const live::ManualOverlayPoint& rhs) {
    return lhs.x == rhs.x && lhs.y == rhs.y;
}

inline bool manual_edge_equals(const live::ManualOverlayEdge& lhs,
                               const live::ManualOverlayEdge& rhs) {
...
inline bool manual_instance_equals(const live::ManualOverlayInstance& lhs,
                                   const live::ManualOverlayInstance& rhs) {
    return lhs.instance_id == rhs.instance_id &&
           lhs.enabled == rhs.enabled &&
           manual_box_equals(lhs.box, rhs.box) &&
           manual_mask_region_equals(lhs.mask_region, rhs.mask_region) &&
           lhs.mask == rhs.mask &&
           ...
           lhs.category_index == rhs.category_index;
}
...
inline bool manual_snapshot_equals(const live::ManualOverlayDocumentSnapshot& lhs,
    ...
    return lhs.document_generation == rhs.document_generation &&
           lhs.session_revision == rhs.session_revision &&
           lhs.capture_width == rhs.capture_width &&
