...
function(mmltk_configure_rfdetr_native)
    ...
    add_library(mmltk_rfdetr_cuda_ops STATIC
        ...
        src/rfdetr/layers/mask_pack_cuda_wrapper.cpp
        src/rfdetr/cuda/ms_deform_attn_cuda.cu
        src/rfdetr/cuda/training_mask_ops_cuda.cu
        src/rfdetr/cuda/gpu_augment_cuda.cu
        src/rfdetr/cuda/mask_pack_cuda.cu
    ...
    mmltk_configure_target_pch(mmltk_rfdetr_cuda_ops
    ...
    if(MMLTK_RFDETR_LIVE_CAPTURE_ENABLED)
        ...
        add_library(mmltk_live_runtime STATIC
            ...
            src/live/workspace_trace.cpp
            src/live/workspace_surface_pool.cpp
            src/live/static_workspace_compositor.cpp
        ...
        mmltk_configure_target_pch(mmltk_live_runtime
            HEADER src/pch/rfdetr_native.hpp)
    endif()
