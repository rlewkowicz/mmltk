...
if(BUILD_TESTS)
    ...
    mmltk_install_target(mmltk_tests_core)
    mmltk_install_target(mmltk_tests_gui)
    ...
    if(BUILD_RFDETR_NATIVE)
        ...
        mmltk_install_target(mmltk_tests_model_rfdetr)
